...
<details>
<summary><b>1. "Monolithic Coupling" ต่างจาก "Segregated Coupling" อย่างไร? เปรียบเทียบให้เห็นภาพ</b></summary>

**คำตอบ:**
*   **Segregated:** เหมือน **การส่งจดหมายโต้ตอบ** (Iterative) ฝั่ง A ส่งข้อมูลไป ฝั่ง B รับแล้วคำนวณ แล้วส่งกลับ ทำวนไปเรื่อยๆ จนกว่าจะตกลงกันได้ (Converged) ในแต่ละ Time step
    *   *ข้อดี:* ใช้ RAM น้อย, แก้ Code ง่าย
    *   *ข้อเสีย:* อาจจะต้องส่งจดหมายหลายรอบมากถ้าระบบมันสัมพันธ์กันแน่น (Strongly Coupled)
*   **Monolithic:** เหมือน **การประชุมจับเข่าคุยพร้อมกัน** (Simultaneous) เอาสมการของ A และ B มารวมเป็นสมการยักษ์ (Block Matrix) แล้วแก้เปรี้ยงเดียวจบ
    *   *ข้อดี:* เสถียรมาก, ลู่เข้าเร็ว
    *   *ข้อเสีย:* สมการยักษ์กิน RAM มหาศาล และเขียน Code ยาก
</details>

<details>
<summary><b>2. Boussinesq Approximation มีข้อจำกัดสำคัญคืออะไร?</b></summary>

**คำตอบ:** ใช้ได้เฉพาะกรณีที่ **ผลต่างอุณหภูมิ (Temperature Difference) ไม่มากนัก** ($\Delta T/T < 0.1$)
*   สมมติฐานหลักคือ ความหนาแน่น ($\rho$) คงที่ในทุกเทอม **ยกเว้น** เทอมแรงลอยตัว (Gravity term)
*   ถ้าอุณหภูมิต่างกันมากๆ (เช่น ไฟไหม้ หรือการเผาไหม้) ความหนาแน่นเปลี่ยนไปเยอะมากแบบ Non-linear วิธีนี้จะใช้ไม่ได้ผล ต้องใช้ Compressible solver แทน
</details>

<details>
<summary><b>3. ทำไม FSI (Fluid-Structure Interaction) แบบ "Two-way Coupling" ถึงยากกว่า "One-way"?</b></summary>

**คำตอบ:** เพราะ **โครงสร้างที่ขยับไป เปลี่ยน Flow field ซึ่งกลับมาเปลี่ยนแรงที่กระทำต่อโครงสร้างทันที** (Feedback Loop)
*   **One-way:** ลมพัดตึก -> ตึกโยก (จบ) เราไม่สนว่าตึกโยกแล้วลมเปลี่ยนทิศไหม
*   **Two-way:** ลมพัดใบพัด -> ใบพัดบิด -> รูปทรงเปลี่ยน -> ลมเปลี่ยนทิศ -> แรงเปลี่ยน -> ใบพัดบิดเพิ่ม -> ... (วนลูป) ถ้าไม่ระวัง Energy จะระเบิด (Instability) จาก Added Mass Effect
</details>