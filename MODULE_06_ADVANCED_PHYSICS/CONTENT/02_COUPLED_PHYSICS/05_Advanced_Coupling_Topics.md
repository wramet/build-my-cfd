...
<details>
<summary><b>1. ในแบบจำลอง PCM, เทอม "Mushy Zone" ทำหน้าที่อะไรในสมการโมเมนตัม?</b></summary>

**คำตอบ:** ทำหน้าที่เป็น **Sink Term (แรงต้าน)** ที่แปรผันตามสัดส่วนของของแข็ง
*   เมื่อเป็นของเหลว ($f=1$) แรงต้าน = 0 (ไหลได้ปกติ)
*   เมื่อเป็นของแข็ง ($f=0$) แรงต้าน = อนันต์ (หยุดนิ่ง)
*   ช่วยให้ solver สามารถแก้สมการเดียวครอบคลุมทั้งโดเมนของเหลวและของแข็งได้โดยไม่ต้องทำ Dynamic Mesh
</details>

<details>
<summary><b>2. ทำไม "Added Mass Effect" ถึงเป็นปัญหาใหญ่ใน FSI ของน้ำ แต่ไม่ใช่ในอากาศ?</b></summary>

**คำตอบ:** เพราะ **ความหนาแน่น**
*   ในน้ำ ($
ho \approx 1000$) มวลของน้ำที่โครงสร้างต้อง "แบก" ไปด้วยมีค่ามหาศาลเมื่อเทียบกับมวลโครงสร้างเอง
*   ในอากาศ ($
ho \approx 1$) มวลที่แบกเพิ่มมีค่าน้อยมากจนตัดทิ้งได้
*   เมื่อ $\frac{\rho_f}{\rho_s}$ สูง การ Coupling แบบ Explicit จะแกว่งและ Diverge เพราะแรงตอบสนองจากของไหลมันรุนแรงและรวดเร็วเกินกว่าที่โครงสร้างจะปรับตัวทัน
</details>

<details>
<summary><b>3. "View Factor" ในการแผ่รังสีบอกอะไรเรา? และสำคัญอย่างไร?</b></summary>

**คำตอบ:** บอก **"สัดส่วนการมองเห็นวิสัยทัศน์"** ระหว่างสองพื้นผิว
*   ถ้า $F_{1-2} = 1$ แสดงว่าผิว 1 มองเห็นผิว 2 เต็มๆ (รังสีทั้งหมดจาก 1 วิ่งชน 2)
*   ถ้า $F_{1-2} = 0$ แสดงว่ามองไม่เห็นเลย (เช่น หันหลังให้กัน หรือมีอะไรบัง)
*   สำคัญมากในการคำนวณ Heat Exchange ในเตาเผาหรือระบบที่ซับซ้อน เพราะรังสีความร้อนวิ่งเป็นเส้นตรง
</details>
