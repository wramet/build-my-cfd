...
> [!TIP] **มุมมองเปรียบเทียบ: ปลอกกระดาษสวมแก้วกาแฟ (The Coffee Cup Sleeve Analog)**
> 
> ลองนึกภาพคุณถือแก้วกาแฟร้อนๆ:
> *   **Fluid Region:** กาแฟร้อนในแก้ว (มี Convection)
> *   **Interface 1:** ผิวด้านในแก้ว (รับความร้อนจากกาแฟ)
> *   **Solid Region 1:** ตัวแก้วกระดาษ (นำความร้อนผ่านความหนา - Conduction)
> *   **Interface 2:** รอยต่อระหว่างแก้วกับปลอกกระดาษ
> *   **Solid Region 2:** ปลอกกระดาษลูกฟูก (เป็นฉนวนกันความร้อน)
> *   **Boundary:** มือของคุณที่สัมผัสผิวนอกปลอก
> *   **CHT Simulation:** คือการคำนวณว่า "ความร้อนจากกาแฟจะส่งผ่านแก้วและปลอกมาถึงมือคุณกี่องศา?" โดยต้องแก้สมการพร้อมกันทั้งในกาแฟ แก้ว และปลอก เพื่อให้แน่ใจว่าอุณหภูมิที่รอยต่อเท่ากันเป๊ะ
...
**เวอร์ชัน OpenFOAM:** 2312+
 ...
 <details>
 <summary><b>1. "Conjugate Heat Transfer" (CHT) ต่างจาก Heat Transfer ปกติอย่างไร?</b></summary>
 
 **คำตอบ:** Heat Transfer ปกติมักจะสมมุติว่าผนังมีอุณหภูมิคงที่ (Fixed Value) หรือฟลักซ์คงที่ (Fixed Gradient) แต่ **CHT คำนวณอุณหภูมิของ Solid และ Fluid ไปพร้อมๆ กัน** โดยอุณหภูมิที่ผิวรอยต่อ (Interface) จะเป็นผลลัพธ์จากการคำนวณ ไม่ใช่ค่าที่กำหนดไว้ล่วงหน้า
 </details>
 
 <details>
 <summary><b>2. ทำไมเราต้องใช้ `mappedWall` boundary condition ที่ Interface?</b></summary>
 
 **คำตอบ:** เพราะ Mesh ของ Fluid และ Solid มักจะไม่ตรงกัน (Non-conformal) `mappedWall` ทำหน้าที่เป็น **สะพานเชื่อมข้อมูล** ที่ช่วย Map ค่าอุณหภูมิและฟลักซ์จากฝั่งหนึ่งไปยังอีกฝั่งหนึ่งได้อย่างถูกต้อง แม้ว่าจุด Node จะไม่ตรงกันก็ตาม
 </details>
 
 <details>
 <summary><b>3. ถ้า Simulation ของ CHT ลู่ออก (Diverge) สิ่งแรกที่ควรปรับคืออะไร?</b></summary>
 
 **คำตอบ:** ควรลองปรับ **Relaxation Factor ของสมการพลังงาน (h หรือ e)** ให้ลดลง (เช่นจาก 0.7 เหลือ 0.5 หรือ 0.3) โดยเฉพาะถ้าวัสดุมีความต่างของค่าการนำความร้อน (Thermal Conductivity) สูงมากๆ (เช่น อากาศกับทองแดง) เพราะการส่งถ่ายความร้อนจะรุนแรงและทำให้ค่าแกว่งได้ง่าย
 </details>
