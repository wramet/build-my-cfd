...
> [!TIP] **มุมมองเปรียบเทียบ: ทีมล่ามแปลภาษา (The Multilingual Team Analogy)**
> 
> ลองจินตนาการถึงทีมทำงานที่พูดกันคนละภาษา:
> *   **โดเมนของไหล (Fluid):** พูดภาษา "Navier-Stokes" (ความเร็ว, ความดัน)
> *   **โดเมนของแข็ง (Solid):** พูดภาษา "Fourier/Elasticity" (อุณหภูมิ, การกระจัด)
> *   **Interface:** คือ "ล่าม" หรือ "นักการทูต" ที่คอยแปลข้อมูลตรงรอยต่อ
> *   **Coupling:** คือกระบวนการสื่อสาร ถ้าล่ามแปลช้า (Weak coupling) งานอาจสะดุด แต่ถ้าล่ามแปลแบบ Real-time (Strong coupling) งานจะลื่นไหลแต่ใช้พลังงานสมองเยอะ
> *   **Stability:** ถ้าคนหนึ่งตะโกน (High flux) แต่อีกคนรับไม่ทัน (Low conductivity) การสื่อสารอาจล้มเหลว (Divergence)!
...
<details>
<summary><b>1. Monolithic vs Partitioned Approach: ต่างกันอย่างไรในแง่ของ "ตารางเรียน"?</b></summary>

**คำตอบ:**
*   **Partitioned (แบบแยกส่วน):** เหมือนเรียนทีละวิชา เรียนคณิตเสร็จ (Fluid) แล้วค่อยไปเรียนฟิสิกส์ (Solid) แล้วเอาความรู้มาเชื่อมโยงกันทีหลัง ประหยัดสมอง (Memory) แต่บางทีเชื่อมโยงไม่ทัน
*   **Monolithic (แบบรวมศูนย์):** เหมือนเรียนบูรณาการพร้อมกันในคาบเดียว แก้สมการทุกอย่างในเมทริกซ์ยักษ์เดียว แม่นยำและเชื่อมโยงแน่นแฟ้น (Robust) แต่ใช้สมอง (Memory) มหาศาล
</details>

<details>
<summary><b>2. "Under-Relaxation" จำเป็นที่สุดเมื่อใดในปัญหา Coupling?</b></summary>

**คำตอบ:** เมื่อ **"คู่สนทนา" มีความเร็วในการตอบสนองต่างกันมาก** หรือ **ข้อมูลเปลี่ยนไวเกินไป**
*   เช่น เมื่อของแข็งร้อนช้ามาก แต่ของไหลพาความร้อนเร็วมาก ถ้าอัปเดตอุณหภูมิที่ผิวทันทีตามของไหล ของแข็งจะรับไม่ทันและค่าจะแกว่ง (Overshoot)
*   การใช้ Relaxation ($\alpha < 1$) ช่วย "ชะลอ" การเปลี่ยนแปลงให้ค่อยเป็นค่อยไป
</details>

<details>
<summary><b>3. ทำไมต้องใช้ PtrList<fvMesh> แทนที่จะใช้ fvMesh ก้อนเดียว?</b></summary>

**คำตอบ:** เพราะ **แต่ละ Region มี Physics และ Topology ต่างกัน**
*   ของไหลอาจต้องการ Mesh ละเอียดแบบหนึ่ง ของแข็งอาจต้องการ Mesh หยาบแบบหนึ่ง
*   การแยก Mesh ช่วยให้เราตั้งค่า Solver (fvSolution, fvSchemes) แยกกันได้อย่างอิสระสำหรับแต่ละ Region
</details>
