...
> [!TIP] **มุมมองเปรียบเทียบ: กระบอกฉีดยาและการดึงลูกสูบ (The Syringe Analogy)**
> 
> ลองจินตนาการว่าคุณมีกระบอกฉีดยาที่มีน้ำอยู่เล็กน้อย แล้วคุณเอานิ้วอุดปลายเข็มไว้แน่น จากนั้นดึงลูกสูบถอยหลังอย่างรวดเร็ว:
> *   **Pressure Drop:** พื้นที่ภายในกระบอกเพิ่มขึ้น แต่ปริมาณน้ำเท่าเดิม ความดันจึงลดลงฮวบฮาบ
> *   **Cavitation:** จู่ๆ คุณจะเห็นฟองอากาศผุดขึ้นมาในน้ำ ทั้งที่ไม่มีความร้อนเลย! นั่นคือน้ำ "เดือด" เพราะความดันต่ำ (Boiling at low pressure)
> *   **Collapse:** พอคุณปล่อยลูกสูบกลับที่เดิม ความดันกลับมาปกติ ฟองเหล่านั้นจะยุบตัวหายไปทันที (พร้อมแรงกระแทกมหาศาลถ้าเป็นในปั๊มน้ำ)
...
<details>
<summary><b>1. Schnerr-Sauer vs Kunz Model: ควรเลือกใช้อันไหนเมื่อไหร่?</b></summary>

**คำตอบ:**
*   **Schnerr-Sauer:** อิงฟิสิกส์ (Bubble Dynamics) ดีกว่าสำหรับ **General Cavitation** (เช่น ในปั๊ม หรือ Hydrofoil ทั่วไป) ที่ต้องการความแม่นยำทางกายภาพ
*   **Kunz:** อิงสมการ Empirical เหมาะสำหรับ **High-Speed Flows** หรือกรณีที่ Schnerr-Sauer ขาดเสถียรภาพ (Unstable) เพราะ Kunz ควบคุมการระเหย/ควบแน่นแยกกันได้อิสระกว่า
</details>

<details>
<summary><b>2. ทำไม Cavitation มักทำให้ Simulation "ระเบิด" (Diverge)?</b></summary>

**คำตอบ:** เพราะ **ความหนาแน่นเปลี่ยนเร็วมาก** (จากน้ำ 1000 kg/m³ เป็นไอ 1 kg/m³ ในระยะทางสั้นๆ)
*   ทำให้เกิด Source term มหาศาลในสมการ Pressure (p_rgh)
*   **วิธีแก้:** ลด Relaxation Factors, ลด Time step, หรือเพิ่มจำนวน PIMPLE loops เพื่อให้ Solver ค่อยๆ ปรับตัว
</details>

<details>
<summary><b>3. ค่า NPSH เกี่ยวข้องอย่างไรกับ CFD?</b></summary>

**คำตอบ:** NPSH (Net Positive Suction Head) คือค่าความดันสุทธิที่ทางเข้าปั๊ม ถ้าเราจำลองปั๊ม เราต้องตั้งค่า Boundary Condition `totalPressure` ที่ทางเข้าให้สอดคล้องกับ NPSH ที่ต้องการทดสอบ ถ้าตั้งความดันต่ำเกินไป -> เกิด Cavitation -> Head Drop
</details>
