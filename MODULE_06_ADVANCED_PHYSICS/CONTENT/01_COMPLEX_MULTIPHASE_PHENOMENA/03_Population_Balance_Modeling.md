...
> [!TIP] **มุมมองเปรียบเทียบ: การสำรวจประชากร (Demographic Census)**
>
> ลองนึกภาพการสำรวจประชากรของประเทศ:
> *   **Euler-Euler ปกติ:** สนใจแค่ "น้ำหนักเฉลี่ยของคนทั้งประเทศ" (Mean Diameter) -> ไม่รู้ว่ามีเด็กกี่คน ผู้ใหญ่กี่คน
> *   **Population Balance (PBM):** สนใจ **"โครงสร้างประชากร"** -> แบ่งเป็นกลุ่มๆ (Classes/bins) เช่น กลุ่ม 0-10 ปี, 11-20 ปี, ...
> *   **Birth Rate:** เด็กเกิดใหม่ (Nucleation/Breakup)
> *   **Death Rate:** คนเสียชีวิต (Coalescence - ฟองเล็กหายไปรวมเป็นฟองใหญ่)
> *   ถ้าเราอยากรู้พฤติกรรมละเอียด (เช่น การศึกษา หรือสุขภาพตามวัย) เราต้องรู้โครงสร้างประชากร ไม่ใช่แค่ค่าเฉลี่ย!
...
<details>
<summary><b>1. เมื่อไหร่ควรใช้ PBM แทนสมมติฐานฟองขนาดคงที่ (Constant Diameter)?</b></summary>

**คำตอบ:** เมื่อ **ขนาดฟองมีการเปลี่ยนแปลงอย่างมีนัยสำคัญ** และ **ขนาดนั้นส่งผลต่อฟิสิกส์**
*   เช่น ใน Bubble Column Reactor (ฟองใหญ่ลอยเร็ว ฟองเล็กอยู่กับที่)
*   หรือใน Emulsion ที่ความเสถียรขึ้นกับขนาดหยดน้ำมัน
*   ถ้าขนาดฟองค่อนข้างสม่ำเสมอทั้งระบบ (Monodisperse) ใช้วิธีปกติประหยัดกว่า
</details>

<details>
<summary><b>2. ข้อดี/ข้อเสียของ QMOM เทียบกับ Class Method (MOC)?</b></summary>

**คำตอบ:**
*   **QMOM (Quadrature Method of Moments):**
    *   **ข้อดี:** **เร็ว**, ใช้ตัวแปรน้อย (แก้แค่ 4-6 โมเมนต์)
    *   **ข้อเสีย:** ไม่เห็นรูปร่างกราฟการแจกแจงจริงๆ (เห็นแค่ค่าเฉลี่ยความกว้าง), บางครั้ง Numerical Unstable
*   **MOC (Method of Classes):**
    *   **ข้อดี:** เห็นกราฟการแจกแจงชัดเจน (Histogram), Physics ตรงไปตรงมา
    *   **ข้อเสีย:** **ช้ามาก** ถ้าต้องการความละเอียดสูง (ต้องแก้สมการ Transport ตามจำนวน Class)
</details>

<details>
<summary><b>3. Coalescence (การรวมตัว) และ Breakup (การแตกตัว) ขึ้นกับอะไรเป็นหลัก?</b></summary>

**คำตอบ:** ขึ้นกับ **Turbulence** และ **Surface Tension**
*   **Breakup:** เกิดเมื่อแรงเฉือนจาก Turbulence ชนะแรงตึงผิว (Weber Number สูง)
*   **Coalescence:** เกิดเมื่อฟองชนกัน (Collision Frequency) และฟิล์มของเหลวระหว่างฟองบางลงจนขาด (Drainage Efficiency)
</details>