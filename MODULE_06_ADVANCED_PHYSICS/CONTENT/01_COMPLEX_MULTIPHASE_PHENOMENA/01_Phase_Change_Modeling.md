...
> [!TIP] **มุมมองเปรียบเทียบ: ประตูหมุนที่สถานีรถไฟ (Turnstile at Train Station)**
>
> ลองจินตนาการว่า **ส่วนต่อประสาน (Interface)** ระหว่างของเหลวและไอ คือ **"ประตูหมุน"** ที่สถานีรถไฟ:
> *   **โมเลกุล:** คือผู้โดยสาร
> *   **Evaporation:** ผู้โดยสารพยายามดันออกจากสถานี (ของเหลว -> ไอ)
> *   **Condensation:** ผู้โดยสารพยายามดันเข้ามาในสถานี (ไอ -> ของเหลว)
> *   **Net Mass Transfer:** คือจำนวนคนที่ผ่านประตูได้จริงๆ (คนออก - คนเข้า)
> *   ถ้าประตูหมุนฝืด (Accommodation Coefficient ต่ำ) คนก็จะผ่านได้น้อย แม้จะอยากออกมากแค่ไหนก็ตาม
...
<details>
<summary><b>1. แบบจำลอง Lee Model มีข้อดีและข้อเสียอย่างไรเทียบกับ Hertz-Knudsen?</b></summary>

**คำตอบ:**
*   **Lee Model:** เป็นแบบ **กึ่งประจักษ์ (Semi-empirical)** ข้อดีคือ **เสถียรมาก (Stable)** และ Implement ง่าย แต่ข้อเสียคือต้องจูนค่าสัมประสิทธิ์ $r$ ให้เหมาะสม
*   **Hertz-Knudsen:** มาจาก **ทฤษฎีจลน์ (Kinetic Theory)** มีพื้นฐานฟิสิกส์ที่แน่นกว่า แต่ใช้งานจริงยากกว่าเพราะต้องการข้อมูลระดับโมเลกุลที่แม่นยำ และมักเกิดความไม่เสถียรทางตัวเลขถ้า Interface ไม่คมชัด
</details>

<details>
<summary><b>2. สัมประสิทธิ์การผ่อนคลาย (Relaxation Coefficient, r) ใน Lee Model คืออะไร?</b></summary>

**คำตอบ:** คือตัวกำหนด **"ความเร็ว"** ในการเปลี่ยนสถานะ
*   ถ้า $r$ มาก: เปลี่ยนสถานะเร็วมาก (อุณหภูมิจะถูกล็อกที่ $T_{sat}$ ทันที) แต่อาจทำให้ Solver พัง (Unstable)
*   ถ้า $r$ น้อย: เปลี่ยนสถานะช้า (อุณหภูมิอาจเกิน $T_{sat}$ ไปบ้าง) แต่การคำนวณจะเสถียรกว่า
</details>

<details>
<summary><b>3. ทำไมเราต้องสนใจ "Interface Sharpness" ในการจำลอง Phase Change?</b></summary>

**คำตอบ:** เพราะสูตรคำนวณการถ่ายเทมวลมักขึ้นกับ **พื้นที่ผิว (Interfacial Area)**
ถ้า Interface เบลอ (Smeared) เราจะประเมินพื้นที่ผิวผิด ทำให้คำนวณอัตราการเดือดหรือควบนแน่นผิดไปจากความเป็นจริงอย่างมาก
</details>
