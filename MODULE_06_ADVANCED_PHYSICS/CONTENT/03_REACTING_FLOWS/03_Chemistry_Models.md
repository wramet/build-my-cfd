...
### ลักษณะเฉพาะทางคณิตศาสตร์ (Mathematical Characterization)
 ...
 > [!TIP] **มุมมองเปรียบเทียบ: การวิ่งมาราธอน vs วิ่ง 100 เมตร (Marathon vs Sprint)**
 >
 > ลองจินตนาการว่าคุณต้องถ่ายวิดีโองานแข่งกีฬาที่มีทั้ง:
 > *   **ปฏิกิริยาเคมีเร็ว (Fast Reaction):** นักวิ่ง 100 เมตร (จบใน 10 วินาที) -> ต้องการกล้องความเร็วสูง (Small Time Step)
 > *   **การไหลของของไหล (Slow Flow):** นักวิ่งมาราธอน (จบใน 2 ชั่วโมง) -> ต้องการกล้องถ่ายทาลแลปส์ (Large Time Step)
 >
 > **ความแข็ง (Stiffness)** คือการที่คุณต้องถ่ายทั้งสองงาน **"พร้อมกันในวิดีโอเดียว"**:
 > - ถ้าใช้ Time Step ใหญ่ (สำหรับมาราธอน) คุณจะมองไม่เห็นนักวิ่ง 100 เมตร (เบลอหรือหายไปเลย -> Simulation Blow up)
 > - ถ้าใช้ Time Step เล็ก (สำหรับ 100 เมตร) คุณต้องถ่ายวิดีโอยาวนานมหาศาลเพื่อจะเห็นนักวิ่งมาราธอนเข้าเส้นชัย (Computational Cost สูงเกินไป)
 >
 > **ทางแก้ (Implicit Solver):** คือการใช้กล้องอัจฉริยะที่สามารถทำนายตำแหน่งนักวิ่งระยะสั้นได้โดยไม่ต้องถ่ายทุกเฟรม (Predictive/Implicit Integration)
 ...
 **คำตอบ:** คือสภาวะที่มี **Time Scale แตกต่างกันอย่างมหาศาล** ในระบบเดียวกัน (เช่น ปฏิกิริยากำจัดอนุมูลอิสระใช้เวลา $10^{-9}$ วินาที แต่การเกิด NOx ใช้เวลา $1$ วินาที) ทำให้ Solver ทั่วไป (Explicit) ต้องใช้ Time Step ที่เล็กเท่าตัวที่เร็วที่สุด ส่งผลให้คำนวณช้ามาก
 ...
 <details>
 <summary><b>2. เมื่อไหร่ควรใช้ StandardChemistryModel vs StandardChemistryModel? (คำถามหลอก)</b></summary>
 
 **คำตอบ:** จริงๆ แล้ว `StandardChemistryModel` เป็น Base Class ที่เราใช้บ่อยที่สุด แต่ตัวเลือก Solver คือสิ่งสำคัญ:
 *   **SEulex:** ดีที่สุดสำหรับกรณีทั่วไป (General Purpose)
 *   **Rosenbrock:** ดีสำหรับเคมีที่แข็งเกร็งมากๆ และจำนวน Species น้อย
 ...
 **คำตอบ:** เพราะนักเคมีชอบใช้ **cal/mol** หรือ **kcal/mol** ในขณะที่ OpenFOAM (และ SI Unit) ใช้ **J/mol** ถ้าไม่แปลง ค่า Reaction Rate จะผิดไปมหาศาล ($e^{-E_a/RT}$) เพราะมันอยู่ใน Exponential Term
 </details>
