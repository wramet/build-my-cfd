...
> [!TIP] **มุมมองเปรียบเทียบ: ครัวขนาดใหญ่ (The Commercial Kitchen)**
>
> ลองจินตนาการว่าการจำลองการไหลแบบมีปฏิกิริยาเหมือนกับ **"การทำอาหารในครัวภัตตาคารขนาดใหญ่"**:
> *   **Species Transport ($Y_i$):** คือการขนส่งวัตถุดิบ (แป้ง, น้ำตาล, ไข่) จากตู้เย็นไปยังกระทะ ถ้าขนส่งไม่ทัน ก็ทำอาหารไม่ได้ (Transport Limited)
> *   **Chemical Kinetics ($\dot{\omega}_i$):** คือขั้นตอนการปรุงในกระทะ (ความร้อนเปลี่ยนแป้งเป็นขนมปัง) ต้องใช้อุณหภูมิและเวลาที่เหมาะสม (Activation Energy)
> *   **Turbulence (Mixing):** คือการ "คน" อาหารในหม้อ ถ้าคนไม่ทั่ว อาหารอาจไหม้เป็นหย่อมๆ หรือไม่สุก (Mixing Limited)
> *   **Heat Release:** คือความร้อนที่ออกมาจากเตาปรุงอาหาร ซึ่งย้อนกลับไปทำให้อุณหภูมิในครัวสูงขึ้น (Exothermic Reaction)
>
> หัวใจสำคัญคือ **"ความเร็วในการคน" (Mixing)** ต้องสมดุลกับ **"ความเร็วในการสุก" (Reaction)** เพื่อให้อาหารออกมาสมบูรณ์แบบ
...
---
 ...
 <details>
 <summary><b>1. ทำไมเราต้องแก้สมการเคมี (Chemistry) แยกจากสมการการไหล (Flow) ใน OpenFOAM (Operator Splitting)?</b></summary>
 
 **คำตอบ:** เพราะ **Time Scale ต่างกันมหาศาล**:
 *   การไหล (Flow) เปลี่ยนแปลงในระดับมิลลิวินาที (ms)
 *   ปฏิกิริยาเคมี (Reaction) บางตัวเกิดในระดับนาโนวินาที (ns)
 *   ถ้าแก้พร้อมกันโดยใช้ Time Step ของการไหล จะทำให้สมการเคมีไม่เสถียร (Unstable) แต่ถ้าใช้ Time Step ของเคมี การคำนวณการไหลจะช้าเกินความจำเป็น
 </details>
 
 <details>
 <summary><b>2. Damköhler Number (Da) บอกอะไรเราเกี่ยวกับการเผาไหม้?</b></summary>
 
 **คำตอบ:** มันบอก **อัตราส่วนระหว่างเวลาผสม (Mixing Time) กับเวลาปฏิกิริยา (Reaction Time)**:
 *   **Da >> 1:** ปฏิกิริยาเร็วมากเมื่อเทียบกับการผสม (Mixing Limited) -> การเผาไหม้ถูกควบคุมโดย Turbulence
 *   **Da << 1:** ปฏิกิริยาช้ามาก (Slow Chemistry) -> สารผสมกันทั่วแล้วแต่ยังไม่ค่อยทำปฏิกิริยา (Well-stirred reactor)
 </details>
 
 <details>
 <summary><b>3. ทำไม Model EDC (Eddy Dissipation Concept) ถึงเหมาะกับ High Turbulence?</b></summary>
 
 **คำตอบ:** เพราะ EDC สมมติว่า **ปฏิกิริยาเกิดขึ้นเฉพาะใน "Fine Structures"** (โครงสร้างขนาดเล็กระดับ Kolmogorov scale) ซึ่งเป็นจุดที่พลังงาน Turbulence ถูกสลาย (Dissipated) เป็นความร้อน โมเดลนี้จึงจับพฤติกรรมการเผาไหม้ในสภาวะที่ Turbulence รุนแรงได้ดีกว่าโมเดลที่มองภาพรวมแบบเฉลี่ย
 </details>
