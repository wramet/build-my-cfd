...
> **รูปที่ 1:** แผนภาพแสดงกลไกหลักสามประการที่ควบคุมการขนส่งสปีชีส์ (Species Transport) ในการไหลแบบมีปฏิกิริยาเคมี ได้แก่ การพา (Convection) จากการไหลหลัก, การแพร่ (Diffusion) จากเกรเดียนต์ความเข้มข้น, และการทำปฏิกิริยาเคมี (Reaction)
 ...
 > [!TIP] **มุมมองเปรียบเทียบ: ระบบส่งพัสดุ (Parcel Delivery System)**
 >
 > ลองมองว่า **Species ($Y_i$)** คือ "พัสดุ" ที่ต้องส่ง:
 > *   **Convection ($\rho \mathbf{u} Y_i$):** คือการขนส่งด้วย **"รถบรรทุก"** (Flow Field) — ถ้ารถวิ่งเร็ว พัสดุก็ไปเร็ว (ไปทิศทางเดียวกันหมด)
 > *   **Diffusion ($\mathbf{J}_i$):** คือการ **"เดินเท้าส่งของ"** ในซอยแคบๆ — พัสดุกระจายตัวจากที่แน่นไปที่ว่าง (อาศัย Gradient ไม่ต้องรอรถบรรทุก)
 > *   **Reaction ($R_i$):** คือจุด **"แปรรูปพัสดุ"** — พัสดุ A กลายเป็นพัสดุ B (เช่น โรงงานประกอบชิ้นส่วน)
 >
 > ในพายุ (Turbulent Flow) การแพร่จะถูกเร่งด้วย "มอเตอร์ไซค์รับจ้าง" (Turbulent Eddies) ทำให้ของกระจายเร็วกว่าเดินเท้าธรรมดา (Molecular Diffusion) มาก!
