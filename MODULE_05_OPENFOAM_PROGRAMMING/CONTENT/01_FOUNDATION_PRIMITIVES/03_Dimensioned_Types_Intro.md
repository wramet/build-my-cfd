...
> [!TIP] **Physical Analogy: The Currency Exchange (บริการแลกเปลี่ยนเงินตรา)**
>
> ลองนึกภาพการทำบัญชี:
>
> -   **การบวก (Addition):** คุณมีเงิน **100 บาท** จะเอาไปบวกกับ **50 ดอลลาร์** ตรงๆ ไม่ได้! (Dimension Mismatch) คุณต้องแปลงให้เป็นหน่วยเดียวกันก่อน
> -   **การคูณ (Multiplication):** แต่ถ้าคุณซื้อผ้า **2 เมตร** ราคาเมตรละ **100 บาท** คุณเอา $2 \times 100 = 200$ บาทได้ (Dimension Set เปลี่ยนจาก [L] * [Cost/L] -> [Cost])
>
> `dimensionedType` ใน OpenFOAM คือ "นักบัญชีที่เข้มงวด" ที่คอยตะโกนห้ามทันทีที่คุณพยายามบวก "บาท" เข้ากับ "ดอลลาร์" หรือบวก "ความเร็ว" เข้ากับ "ความดัน" ทำให้คุณรู้ตัวว่าสมการผิดแน่ๆ ก่อนที่จะรันโปรแกรม
...
1.  **ถ้าเราเขียน `scalar p = 1e5;` แทนที่จะเป็น `dimensionedScalar p("p", dimPressure, 1e5);` จะมีความเสี่ยงอะไร?**
    <details>
    <summary>เฉลย</summary>
    ความเสี่ยงคือ **การสูญเสียการตรวจสอบความถูกต้องทางฟิสิกส์** เราอาจเผลอนำ `p` ไปบวกกับ `U` (ความเร็ว) ได้โดยที่คอมไพเลอร์ไม่รู้เรื่อง ทำให้เกิดบั๊กที่หายากมากในภายหลัง
    </details>

2.  **`dimensionSet(1, -3, 0, 0, 0, 0, 0)` หมายถึงหน่วยอะไร?**
    <details>
    <summary>เฉลย</summary>
    หมายถึง **ความหนาแน่น (Density, $\rho$)** หรือหน่วย $\text{kg}/\text{m}^3$
    - Mass (M) = 1 ($\text{kg}^1$)
    - Length (L) = -3 ($\text{m}^{-3}$)
    </details>

3.  **ทำไม OpenFOAM ถึงอนุญาตให้เอา "ความเร็ว" คูณ "ความหนาแน่น" ได้ แต่บวกกันไม่ได้?**
    <details>
    <summary>เฉลย</summary>
    เพราะ **การคูณ** เป็นการสร้างปริมาณใหม่ที่มีมิติผสม (เช่น $\rho \times U$ ได้โมเมนตัม) ซึ่งถูกต้องทางฟิสิกส์
    แต่ **การบวก** ต้องทำในปริมาณประเภทเดียวกันเท่านั้น (Homogeneity) การบวกสิ่งที่ต่างกัน (เช่น มวล + เวลา) ไม่มีความหมายในโลกความเป็นจริง
    </details>