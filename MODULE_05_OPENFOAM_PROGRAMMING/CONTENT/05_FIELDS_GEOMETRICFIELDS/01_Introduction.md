...
```
> **Figure 1:** แผนผังแนวคิดโดยรวมของระบบฟิลด์ใน OpenFOAM ซึ่งรวบรวมรากฐานทางคณิตศาสตร์ สถาปัตยกรรมการออกแบบ และระบบความปลอดภัยเข้าไว้ด้วยกันความปลอดภัยทางฟิสิกส์ไม่ส่งผลกระทบต่อความเร็วในการจำลอง ผ่านการใช้พลังของ C++ Template Metaprogramming ในการตรวจสอบความสอดคล้องทางมิติทั้งหมดที่ขั้นตอนการคอมไพล์โปรแกรมเพียงครั้งเดียว
...
```
> **Figure 2:** ลำดับชั้นการสืบทอดของคลาสฟิลด์แบบย่อ ซึ่งแสดงเลเยอร์หลักจากข้อมูลดิบไปสู่ข้อมูลทางเรขาคณิตและฟิสิกส์พร้อมคำอธิบายหน้าที่ในแต่ละระดับความปลอดภัยทางฟิสิกส์ไม่ส่งผลกระทบต่อความเร็วในการจำลอง ผ่านการใช้พลังของ C++ Template Metaprogramming ในการตรวจสอบความสอดคล้องทางมิติทั้งหมดที่ขั้นตอนการคอมไพล์โปรแกรมเพียงครั้งเดียว
...
flowchart LR
    ...
    G --> H
```
> **Figure 3:** ความสัมพันธ์ระหว่างการตัดสินใจด้านการออกแบบระบบฟิลด์กับผลกระทบเชิงบวกที่เกิดขึ้นต่อประสิทธิภาพและความถูกต้องในการจำลอง CFD ขนาดใหญ่ความปลอดภัยทางฟิสิกส์ไม่ส่งผลกระทบต่อความเร็วในการจำลอง ผ่านการใช้พลังของ C++ Template Metaprogramming ในการตรวจสอบความสอดคล้องทางมิติทั้งหมดที่ขั้นตอนการคอมไพล์โปรแกรมเพียงครั้งเดียว
