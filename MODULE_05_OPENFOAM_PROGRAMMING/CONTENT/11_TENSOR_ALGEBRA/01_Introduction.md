...
- **องค์ประกอบแนวทแยง (Diagonal Components)** ($\tau_{xx}$,1$\tau_{yy}$,1$\tau_{zz}$): แทน **ความเค้นตั้งฉาก (normal stresses)** ที่กระทำตั้งฉากกับหน้าของตัวเอง
- **องค์ประกอบนอกแนวทแยง (Off-Diagonal Components)** ($\tau_{xy}$,1$\tau_{xz}$, ฯลฯ): แทน **ความเค้นเฉือน (shear stresses)** ที่กระทำขนานไปกับหน้า
...
> - สมการ:1$\boldsymbol{\sigma} = -p\mathbf{I} + 2\mu\boldsymbol{\varepsilon}$
...
-1$\sigma_1$: **ความเค้นหลักที่หนึ่ง** (ความเค้นตั้งฉากสูงสุด)
-1$\sigma_2$: **ความเค้นหลักที่สอง** (ความเค้นตั้งฉากปานกลาง)
-1$\sigma_3$: **ความเค้นหลักที่สาม** (ความเค้นตั้งฉากต่ำสุด)
...
- แต่ละองค์ประกอบ1$R_{ij} = -\rho \overline{u'_i u'_j}1แทนความสัมพันธ์ของความเร็วผันผวนในทิศทาง i และ j
...
- สมการ:1$\boldsymbol{\sigma} = -p\mathbf{I} + 2\mu\boldsymbol{\varepsilon}1ใช้คำนวณแรงภายในของไหลนิวตัน
...
- ถ้า1$\tau_{ij} \neq \tau_{ji}1→ จะเกิด **couple** (แรงบิด) ทำให้เกิดการหมุนที่ไม่สมดุล
- สภาวะสมดุลต้องการ1$\tau_{xy} = \tau_{yx}$,1$\tau_{xz} = \tau_{zx}$,1$\tau_{yz} = \tau_{zy}$
