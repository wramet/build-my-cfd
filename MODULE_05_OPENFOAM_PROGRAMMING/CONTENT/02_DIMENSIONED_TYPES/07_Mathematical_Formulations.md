...
> [!TIP] **Physical Analogy: The Universal Recipe (สูตรอาหารสากล)**
>
> Buckingham π Theorem (ทฤษฎีบทพายของบัคกิงแฮม) เปรียบเสมือน **"การแปลงสูตรอาหารให้เป็นสัดส่วน"**:
>
> 1.  **Dimensional Variables (ตัวแปรมีหน่วย)**: เหมือนสูตรที่ระบุว่า "ใช้แป้ง 500 กรัม, น้ำ 300 มล., ยีสต์ 10 กรัม" (หน่วยเหล่านี้ผูกติดกับขนาดชามผสมของคุณ)
> 2.  **Dimensionless Groups (กลุ่มไร้มิติ)**: เหมือนสูตรที่ระบุว่า "อัตราส่วนน้ำต่อแป้ง = 0.6" (Hydration ratio) และ "อัตราส่วนยีสต์ต่อแป้ง = 0.02"
> 3.  **Similarity (ความคล้ายคลึง)**: ไม่ว่าคุณจะอบขนมปังในครัวบ้าน (Model Scale) หรือในโรงงานอุตสาหกรรม (Prototype Scale) ถ้าคุณใช้อัตราส่วน (Dimensionless Numbers) เท่ากัน รสชาติและเนื้อสัมผัส (Flow Physics) จะออกมาเหมือนกันเป๊ะ!
...
1.  **ทฤษฎีบท Buckingham π เกี่ยวข้องอย่างไรกับการเลือก "Reference Scales"?**
    <details>
    <summary>เฉลย</summary>
    ทฤษฎีบทนี้บอกเราว่าเราต้องการค่าอ้างอิง (Reference Scales) จำนวน $k$ ตัว (เท่ากับจำนวนมิติพื้นฐาน) เพื่อทำให้ตัวแปรอื่นๆ ทั้งหมดเป็นไร้มิติ การเลือก Reference Scales ที่ดี (เช่น เลือกความยาวของปีกเครื่องบิน แทนที่จะเป็นความยาวของน็อต) จะทำให้ตัวเลขไร้มิติที่ได้ (เช่น Re) มีความหมายทางฟิสิกส์ที่ชัดเจน
    </details>

2.  **ทำไม Reynolds Number ถึงเป็น "Dynamic Similarity Parameter"?**
    <details>
    <summary>เฉลย</summary>
    เพราะ Reynolds Number ($\frac{\rho U L}{\mu}$) คืออัตราส่วนระหว่าง **แรงเฉื่อย** (Inertial Force) กับ **แรงหนืด** (Viscous Force) การที่ Re เท่ากันหมายความว่าสมดุลของแรงสองชนิดนี้เหมือนกัน ทำให้พฤติกรรมการไหล (เช่น การเกิด Vortex, ความหนาของ Boundary Layer) เหมือนกัน แม้ขนาดหรือความเร็วจะต่างกันก็ตาม
    </details>

3.  **ในโค้ด `verifyNewtonianConstitutive` ทำไมต้องเช็ค `mu.dimensions() * gammaDot.dimensions()`?**
    <details>
    <summary>เฉลย</summary>
    เพื่อตรวจสอบความถูกต้องของสมการ $\tau = \mu \dot{\gamma}$ ตามหลัก **Dimensional Homogeneity** มิติของความเค้น ($\tau$) ทางซ้ายของสมการ **ต้องเท่ากับ** ผลคูณของมิติความหนืด ($\mu$) และอัตราความเครียด ($\dot{\gamma}$) ทางขวาของสมการ หากไม่เท่ากันแสดงว่าสมการผิดหลักฟิสิกส์
    </details>