...
```mermaid
%%{init: { "theme": "default", "useMaxWidth": false, "themeVariables": { "fontSize": "20px", "fontFamily": "Consolas, 'Courier New', monospace" } }}%%
graph TD
...
## 5. ปฏิบัติการ: งานทักษะและการเขียนโค้ด (Hands-on: Practical Tasks & Coding) {#5-hands-on-practical-tasks--coding}
