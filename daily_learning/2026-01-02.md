...
- **Navier-Stokes Equations**: เข้าใจสมการควบคุมการไหลและรูปแบบอินทิกรัล
- **FVM Principles**: เข้าใจหลักการดิสครีไทซ์แบบ Finite Volume (Space & Time)
- **Class Hierarchy**: เข้าใจโครงสร้างคลาสหลักของ OpenFOAM (`fvMesh`, `GeometricField`, `fvm`/`fvc`)
- **Configuration**: สามารถตั้งค่า `fvSchemes` และ `fvSolution` ได้อย่างถูกต้อง
- **Implementation**: เขียนโค้ดพื้นฐานสำหรับ Convection, Diffusion และ SIMPLE algorithm ได้
