...
- [1. Theory: Core Equations & Physics](#1-theory-core-equations--physics)
  - [1.1 General Transport Equation (สมการการขนส่งทั่วไป)](#11-general-transport-equation-สมการการขนส่งทั่วไป)
  - [1.2 Integral Form (รูปแบบปริพันธ์)](#12-integral-form-รูปแบบปริพันธ์)
  - [1.3 Discretization (การกระจายค่า/การแบ่งส่วน)](#13-discretization-การกระจายค่าการแบ่งส่วน)
  - [1.4 Navier-Stokes Equations (สมการนาเวียร์-สโตกส์)](#14-navier-stokes-equations-สมการนาเวียร์-สโตกส์)
  - [1.5 Spatial Discretization Schemes (รูปแบบการกระจายค่าเชิงพื้นที่)](#15-spatial-discretization-schemes-รูปแบบการกระจายค่าเชิงพื้นที่)
  - [1.6 Temporal Discretization (การกระจายค่าเชิงเวลา)](#16-temporal-discretization-การกระจายค่าเชิงเวลา)
- [2. OpenFOAM Class Hierarchy & Implementation](#2-openfoam-class-hierarchy--implementation)
  - [2.1 SIMPLE Algorithm Flow](#21-simple-algorithm-flow)
  - [2.2 Core Finite Volume Classes](#22-core-finite-volume-classes)
  - [2.2 Discretization Schemes](#22-discretization-schemes)
  - [2.3 Surface Interpolation Schemes](#23-surface-interpolation-schemes)
  - [2.4 Temporal Discretization](#24-temporal-discretization)
  - [2.5 Gradient Schemes](#25-gradient-schemes)
  - [2.6 Divergence Schemes](#26-divergence-schemes)
  - [2.7 Laplacian Schemes](#27-laplacian-schemes)
  - [2.8 Linear Solvers](#28-linear-solvers)
  - [2.9 Boundary Conditions](#29-boundary-conditions)
  - [2.10 Complete Class Relationship Diagram](#210-complete-class-relationship-diagram)
  - [2.11 Key Source File Locations Summary](#211-key-source-file-locations-summary)
...
- [6. Concept Checks](#6-concept-checks)
  - [6.1 General Transport Equation](#61-general-transport-equation)
  - [6.2 Finite Volume Discretization](#62-finite-volume-discretization)
  - [6.3 Spatial Discretization Schemes](#63-spatial-discretization-schemes)
  - [6.4 Temporal Discretization](#64-temporal-discretization)
  - [6.5 Linear Solvers & Algorithms](#65-linear-solvers--algorithms)
...
**สรุปส่วนที่ 1:** ส่วนนี้อธิบายทฤษฎีพื้นฐานของ Finite Volume Method โดยเริ่มจากสมการการขนส่งทั่วไปและรูปแบบปริพันธ์ที่เป็นหลักการของ FVM จากนั้นนำเสนอสมการนาเวียร์-สโตกส์และวิธีการกระจายค่าทั้งเชิงพื้นที่และเชิงเวลา ซึ่งเป็นพื้นฐานสำคัญในการแก้ปัญหา CFD ด้วย OpenFOAM
...
**สรุปส่วนที่ 2:** ส่วนนี้นำเสนอโครงสร้างคลาสและลำดับชั้นของ OpenFOAM โดยเน้นที่คลาสหลักของ Finite Volume Method เช่น fvMesh, fvMatrix และ discretization schemes ต่างๆ พร้อมทั้งแสดงแผนภาพความสัมพันธ์และตำแหน่งไฟล์ต้นฉบับ ซึ่งช่วยให้เข้าใจการออกแบบซอฟต์แวร์และการทำงานภายในของ OpenFOAM
...
**สรุปส่วนที่ 3:** ส่วนนี้อธิบายโครงสร้างและการทำงานของคลาสสำคัญใน OpenFOAM ได้แก่ fvMesh สำหรับจัดการ mesh, fvSchemes สำหรับเลือกรูปแบบการกระจายค่า และ fvSolution สำหรับตั้งค่าการแก้สมการ โดยมีตัวอย่างโค้ดและแผนภาพ memory layout เพื่อให้เข้าใจการเก็บข้อมูลและการเข้าถึงข้อมูลภายในคลาสแต่ละประเภท
...
**สรุปส่วนที่ 4:** ส่วนนี้วิเคราะห์ไฟล์การตั้งค่าของ OpenFOAM ได้แก่ fvSchemes และ fvSolution โดยอธิบายความหมายของแต่ละ parameter และวิธีการเลือกค่าที่เหมาะสม ทั้งนี้ยังมีตารางสรุปแนวทางการเลือกค่าสำหรับสถานการณ์ที่แตกต่างกัน เช่น steady-state, transient และ flow ที่ซับซ้อน
...
**สรุปส่วนที่ 5:** ส่วนนี้นำเสนอแบบฝึกหัดปฏิบัติการเขียนโค้ด 3 ข้อ ได้แก่ การ implement การกระจายค่าแบบ 1D, การสร้าง custom discretization scheme และการสร้าง boundary condition แบบ custom โดยมีโค้ดตัวอย่างและคำอธิบายโดยละเอียด เพื่อให้ผู้อ่านสามารถนำไปประยุกต์ใช้กับปัญหาจริงได้
...
**สรุปส่วนที่ 6:** ส่วนนี้เป็นแบบทดสอบความเข้าใจเกี่ยวกับแนวคิดหลักของ Finite Volume Method และ OpenFOAM โดยครอบคลุมทั้งสมการการขนส่งทั่วไป, การกระจายค่า, รูปแบบของ schemes และการตั้งค่า solvers ซึ่งมีคำตอบอธิบายโดยละเอียดเพื่อใช้เป็นแนวทางในการทบทวนความรู้
