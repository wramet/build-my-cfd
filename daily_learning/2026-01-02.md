...
| $f_x$ | Interpolation Factor | น้ำหนักสำหรับ linear interpolation: $f_x = \frac{\lvert \mathbf{C}_N - \mathbf{C}_f \rvert}{\lvert \mathbf{C}_N - \mathbf{C}_P \rvert}$ | dimensionless |
