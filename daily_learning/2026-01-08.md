...
> **สรุป Section 1:** This section established the mathematical foundation for iterative solvers in CFD, covering sparse matrix storage formats (CSR/CSC), Krylov subspace methods (CG, GMRES, BiCGStab), and preconditioning strategies (Jacobi, ILU0, AMG). We explored how phase change expansion terms affect matrix conditioning and why two-phase flows require more robust solvers than single-phase cases.
...
> **สรุป Section 4:** This section implemented a complete sparse matrix solver library in C++ with CSR matrix storage, CG and BiCGStab iterative solvers, and Jacobi/ILU0 preconditioners. The implementation includes critical safeguards for numerical stability when handling ill-conditioned systems from two-phase phase change, with comprehensive unit tests validating correctness against analytical solutions.
...
- Previous: [[2026-01-07]] - Finite Volume Discretization
- Next: [[2026-01-09]] - Pressure-Velocity Coupling Algorithms
- See also: [[90_day_roadmap]], [[2026-01-06]] - Mesh Generation
