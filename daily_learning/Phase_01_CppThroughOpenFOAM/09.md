...
**Next:** Day 10 — Operator Overloading: `Field<T>` Operators

> **Today's goal:** Understand the expression template pattern, how naive operator overloading creates excessive temporaries, and how expression templates eliminate them by deferring evaluation until assignment.
