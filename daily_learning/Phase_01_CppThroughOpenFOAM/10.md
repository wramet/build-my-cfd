# Day 10: Expression Templates — Zero-Allocation Engine (Part 2) & Expression Templates Part 2
...
## Part 2: Expression Templates Part 2 — The Solution
...
int main() {
    std::cout << "=== Day 10: Expression Templates Part 2 Demo ===\n\n";
...
**Output:**
```text
=== Day 10: Expression Templates Part 2 Demo ===
...
| Expression Templates Part 2 (`import`) | 30 sec | 4 min | **10x** |
...
**Sources:**
- [Expression Templates Part 2 - cppreference](https://en.cppreference.com/w/cpp/language/modules)
- [Expression Templates Part 2 - MSVC Guide](https://learn.microsoft.com/en-us/cpp/build/modules-cpp)
- [Expression Templates Part 2 - clang](https://clang.llvm.org/docs/Modules.html)
