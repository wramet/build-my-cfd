...
**Previous:** Day 11 — Iterators: `forAll` Macro vs Range-Based For
**Next:** Day 13 — Mini-Project Part 1: Type-Safe `Field<T>` with Expression Templates

> **Today's goal:** Understand C++ type traits, SFINAE (Substitution Failure Is Not An Error), and how OpenFOAM's runtime type information system (`TypeName`, `typeInfo`) enables safe downcasting and object factories.
