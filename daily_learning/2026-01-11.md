...
*   **Day 05: Mesh Topology & Day 07: Linear Algebra (LDU)**
    ...
    *   **Flow of Logic:** Day 05/07 สอนโครงสร้าง `lduMatrix` (L, D, U) → Day 11 ใช้ความรู้นั้นเพื่อเข้าใจว่า `S_p ≤ 0` ช่วยเพิ่ม *diagonal dominance* ของ matrix `A` อย่างไร ทำให้ iterative solver ([[Day 08: Iterative Solvers (PCG & PBiCGStab)|Day 08]]) ทำงานได้稳定ขึ้น
