...
classDiagram
    ...
    GeometricField <-- fvMesh : uses
    GeometricField o-- fvPatchField : contains
    fvMatrix o-- GeometricField : discretizes
    turbulenceModel --> GeometricField : accesses
    Time --> fvMesh : controls
```
...
>
> **Source Reference:** `$FOAM_SRC/applications/solvers/incompressible/icoFoam/UEqn.H`
...
#### Memory Layout: fvMesh

> [!INFO] **Internal Data Structure**
> The `fvMesh` class stores mesh topology and geometric data needed for finite volume calculations. Understanding this layout helps optimize memory usage and access patterns.
...
├── polyMesh (base class)
│   ├── points_  ──────────────────────┐
│   │   └── pointField (List<point>)  │  [x,y,z] coordinates
│   ├── faces_  ──────────────────────┼──┐
│   │   └── faceList (List<face>)     │  │  List of point indices
│   ├── cells_  ──────────────────────┼──┼──┐
│   │   └── cellList (List<cell>)     │  │  │  List of face indices
│   └── owner_ / neighbour_ ──────────┼──┼──┼──┐
│       └── labelList                 │  │  │  │  Cell ownership
│                                    │  │  │  │
├── fvSchemes (reference)            │  │  │  │
│   └── dictionary                   │  │  │  │
│                                    │  │  │  │
├── fvSolution (reference)           │  │  │  │
│   └── dictionary                   │  │  │  │
│                                    │  │  │  │
├── V_  ─────────────────────────────┼──┼──┼──┼──┐
│   └── volScalarField               │  │  │  │  │ Cell volumes
│                                    │  │  │  │  │
├── Sf_  ────────────────────────────┼──┼──┼──┼──┼──┐
│   └── surfaceVectorField           │  │  │  │  │  │ Face area vectors
│                                    │  │  │  │  │  │
├── Cf_  ────────────────────────────┼──┼──┼──┼──┼──┼──┐
│   └── surfaceVectorField           │  │  │  │  │  │  │ Face centers
│                                    │  │  │  │  │  │  │
└── lduAddressing_  ─────────────────┼──┼──┼──┼──┼──┼──┼──┐
    └── lduMeshAddressing            │  │  │  │  │  │  │  │
        ├── lowerAddr_ ──────────────┼──┼──┼──┼──┼──┼──┼──┼──┐
        │   └── labelList            │  │  │  │  │  │  │  │  │ Owner of faces
        ├── upperAddr_ ──────────────┼──┼──┼──┼──┼──┼──┼──┼──┼──┐
        │   └── labelList            │  │  │  │  │  │  │  │  │  │ Neighbour of faces
        └── patchStarts_ ────────────┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┐
            └── labelList            │  │  │  │  │  │  │  │  │  │  │ Boundary patch offsets
                                     │  │  │  │  │  │  │  │  │  │  │
Data Arrays (contiguous memory):     │  │  │  │  │  │  │  │  │  │  │
├── points[nPoints]                  ◄──┼──┼──┼──┼──┼──┼──┼──┼──┼──┘
├── faces[nFaces]                    ◄──┼──┼──┼──┼──┼──┼──┼──┼──┘
├── cells[nCells]                    ◄──┼──┼──┼──┼──┼──┼──┼──┘
├── V[nCells]                        ◄──┼──┼──┼──┼──┼──┼──┘
├── Sf[nInternalFaces + nBoundaryFaces] ◄──┼──┼──┼──┼──┼──┘
├── Cf[nInternalFaces + nBoundaryFaces] ◄──┼──┼──┼──┼──┘
├── lowerAddr[nInternalFaces]        ◄──┼──┼──┼──┼──┘
├── upperAddr[nInternalFaces]        ◄──┼──┼──┼──┼──┘
└── patchStarts[nPatches]            ◄──┼──┼──┼──┼──┘
                                     │  │  │  │  │
...
├── Random: face→cell connectivity   │  │  │  │  │
├── Sequential: field iteration      │  │  │  │  │
└── Cache-friendly: cell-based loops │  │  │  │  │
                                     │  │  │  │  │
Key: ─── : pointer/reference         │  │  │  │  │
     ┌──┐ : array container          │  │  │  │  │
     ◄─── : points to data           │  │  │  │  │
                                     │  │  │  │  │
Typical Memory Usage (1M cells):     │  │  │  │  │
├── points:    ~12 MB (double)       │  │  │  │  │
├── faces:     ~80 MB (indices)      │  │  │  │  │
├── cells:     ~40 MB (indices)      │  │  │  │  │
├── V:         ~8 MB (double)        │  │  │  │  │
...
└── Total:     ~200+ MB              │  │  │  │  │
                                     │  │  │  │  │
> [!TIP] **Optimization Notes**      │  │  │  │  │
> - Fields (V, Sf, Cf) use lazy      │  │  │  │  │
>   evaluation - computed on demand  │  │  │  │  │
> - lduAddressing enables efficient  │  │  │  │  │
>   sparse matrix operations         │  │  │  │  │
> - Cache misses occur when          │  │  │  │  │
>   iterating faces vs cells         │  │  │  │  │
```

> [!WARNING] **Memory Alignment**
> - OpenFOAM uses `List<T>` which guarantees contiguous memory
> - `Vector` and `Tensor` types are typically aligned to 16-byte boundaries
> - Always prefer cell-based iteration over face-based when possible
...
>
> **Source Reference:** `$FOAM_SRC/applications/solvers/incompressible/icoFoam/pEqn.H`
...
#### Memory Layout: fvMatrix

> [!INFO] **Matrix Storage Format**
> The `fvMatrix` class stores the discretized equation in LDU (Lower-Diagonal-Upper) format, which is a compressed sparse row format optimized for finite volume meshes.

**ASCII Diagram:**

```
fvMatrix<Type> object (e.g., fvScalarMatrix for p)
├── psi_  ────────────────────────────────┐
...
│   ├── lower_  ────────────────────────────┼──┼──┐
│   │   └── scalarField                     │  │  │
│   │       └── [L] Lower triangular coeffs │  │  │
│   ├── upper_  ────────────────────────────┼──┼──┼──┐
│   │   └── scalarField                     │  │  │  │
│   │       └── [U] Upper triangular coeffs │  │  │  │
│   └── diag_  ─────────────────────────────┼──┼──┼──┼──┐
│       └── scalarField                     │  │  │  │  │
...
└── faceFluxCorrectionPtr_  ─────────────────┼──┼──┼──┼──┼──┼──┼──┼──┐
    └── surfaceScalarField*                  │  │  │  │  │  │  │  │  │
        └── Optional flux correction         │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │
Matrix Structure (for nCells = 6):          │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │
    Cell 0:  D₀ + L₀₁ + L₀₂ + L₀₃           │  │  │  │  │  │  │  │  │
    Cell 1:  D₁ + U₁₀ + L₁₂ + L₁₄           │  │  │  │  │  │  │  │  │
    Cell 2:  D₂ + U₂₀ + U₂₁ + L₂₃           │  │  │  │  │  │  │  │  │
    ...
    Cell 5:  D₅ + U₅₄                       │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │
Storage Layout (contiguous arrays):         │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │
    diag[nCells]      = [D₀, D₁, D₂, D₃, D₄, D₅]  │  │  │  │  │  │  │
    source[nCells]    = [S₀, S₁, S₂, S₃, S₄, S₅]  │  │  │  │  │  │  │
    lower[nInternalFaces] = [L₀₁, L₀₂, L₀₃, L₁₂, L₁₄, L₂₃, L₄₅]  │  │  │  │  │
    upper[nInternalFaces] = [U₁₀, U₂₀, U₃₀, U₂₁, U₄₁, U₃₂, U₅₄]  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │
Addressing (from lduMeshAddressing):         │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │
    lowerAddr = [0, 0, 0, 1, 1, 2, 4]  ──────┼──┼──┼──┼──┼──┼──┼──┼──┼──┘
    upperAddr = [1, 2, 3, 2, 4, 3, 5]  ──────┼──┼──┼──┼──┼──┼──┼──┼──┘
                                             │  │  │  │  │  │  │  │
Matrix-Vector Product (A × x):               │  │  │  │  │  │  │  │
    ...
    result[i] = D[i] * x[i]                  │  │  │  │  │  │  │  │
              ...
              + Σ U[i,j] * x[j] (j > i)      │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │
Memory Usage (1M cells, ~5M faces):          │  │  │  │  │  │  │  │
├── diag:    ~8 MB (scalar)                  │  │  │  │  │  │  │  │
├── source:  ~8 MB (scalar)                  │  │  │  │  │  │  │  │
├── lower:   ~40 MB (scalar)                 │  │  │  │  │  │  │  │
├── upper:   ~40 MB (scalar)                 │  │  │  │  │  │  │  │
├── boundary: ~4 MB (scalar)                 │  │  │  │  │  │  │  │
└── Total:   ~100 MB per matrix              │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │
> [!TIP] **Sparse Matrix Efficiency**        │  │  │  │  │  │  │  │
> - LDU format stores only non-zero coeffs   │  │  │  │  │  │  │  │
> - Memory: O(nFaces) vs O(nCells²) for dense│  │  │  │  │  │  │  │
> - Matrix-vector: O(nFaces) complexity      │  │  │  │  │  │  │  │
> - Symmetric matrices: lower == upper^T     │  │  │  │  │  │  │  │
```

> [!WARNING] **Boundary Coefficients**
> - `internalCoeffs`: Applied to boundary cell values (LHS)
> - `boundaryCoeffs`: Added to source term (RHS)
> - Separation allows efficient BC updates without matrix reconstruction
...
>
> **Source Reference:** `$FOAM_SRC/applications/solvers/incompressible/icoFoam/createFields.H`
...
#### Memory Layout: GeometricField

> [!INFO] **Field Data Organization**
> The `GeometricField` class template is the foundation for all field types in OpenFOAM. It manages data storage, boundary conditions, and geometric interpolation for finite volume fields.

**ASCII Diagram:**

```
GeometricField<Type, PatchField, GeoMesh> (e.g., volScalarField p)
├── IOobject (base class for file I/O)
│   ├── name_  ────────────────────────────────┐
│   │   └── word ("p", "U", "T")               │  Field name
│   ├── instance_  ────────────────────────────┼──┐
│   │   └── word ("0", "1.5", "constant")      │  │ Time directory
│   ├── local_  ───────────────────────────────┼──┼──┐
│   │   └── bool                               │  │  │ Local vs global
│   └── db_  ──────────────────────────────────┼──┼──┼──┐
│       └── objectRegistry&                    │  │  │  │ Reference to Time/db
│                                              │  │  │  │
├── dimensions_  ───────────────────────────────┼──┼──┼──┼──┐
│   └── dimensionSet                           │  │  │  │  │
│       └── [mass length time temperature]     │  │  │  │  │
...
│       │           └── [internalField data]   │  │  │  │  │  │  │
│       └── mesh_  ────────────────────────────┼──┼──┼──┼──┼──┼──┼──┐
│           └── const GeoMesh&                 │  │  │  │  │  │  │  │ Reference to mesh
│                                              │  │  │  │  │  │  │  │
├── boundaryField_  ───────────────────────────┼──┼──┼──┼──┼──┼──┼──┼──┐
...
│   └── (provides BC evaluation interface)     │  │  │  │  │  │  │  │  │  │  │  │  │  │
│                                              │  │  │  │  │  │  │  │  │  │  │  │  │  │
└── storedOldTimePoint_  ──────────────────────┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┐
    └── PtrList<GeometricField>                │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
        └── [0] oldTimeField  ─────────────────┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┐
            └── [1] olderTimeField             │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
Memory Layout (volScalarField p, 1M cells):  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    Internal Field (cell centers):           │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    └── p.internalField()[nCells]            │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
        └── [p₀, p₁, p₂, ..., p₉₉₉₉₉₉]      │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
        Contiguous memory: ~8 MB              │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    Boundary Fields (patch faces):           │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    ├── p.boundaryField()[patchI][start:end] │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    │   └── [face values for patch]          │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    ├── inlet:  [100 faces]  ~0.8 MB         │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    ├── outlet: [200 faces]  ~1.6 MB         │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    ├── walls:  [50000 faces] ~400 KB        │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    └── Total boundary: ~2.4 MB              │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    Old Time Fields:                         │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    ├── p.oldTime()  ────────────────────────┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┐
    │   └── [p⁰₀, p⁰₁, ..., p⁰₉₉₉₉₉₉]       │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
    └── p.oldTime().oldTime() ───────────────┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┼──┐
        └── [p⁻¹₀, p⁻¹₁, ..., p⁻¹₉₉₉₉₉₉]    │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
Total Memory per field:                      │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
├── Internal:  ~8 MB                          │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
├── Boundary:  ~2.4 MB                        │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
├── Old times: ~16 MB (2 levels)              │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
└── Total:    ~26 MB per volScalarField       │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
For volVectorField (U):                       │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
└── Total: ~78 MB (3x scalar)                 │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
                                             │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
> [!TIP] **Field Access Patterns**            │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
> - Internal field: p[i] or p.internalField()[i] │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
> - Boundary field: p.boundaryField()[patchI][faceI] │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
> - Cell values include boundary cells        │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
> - Use ref() for temporary, const access     │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │  │
```

> [!WARNING] **Memory Management**
> - `tmp<GeometricField>`: Smart pointer for temporary fields (auto-deleted)
> - `ref()`: Increment reference count for shared ownership
> - Old time fields stored only if requested by scheme
> - Boundary conditions evaluated on-demand (lazy evaluation)
...
> **Related Source:** `$FOAM_SRC/applications/solvers/basic/scalarTransportFoam/`
>
...
> **Related Source:** `$FOAM_SRC/applications/solvers/incompressible/simpleFoam/`
>
...
> **Related Source:** `$FOAM_SRC/applications/solvers/incompressible/pimpleFoam/`
>
...
> **Related Source:** `$FOAM_SRC/applications/solvers/incompressible/porousSimpleFoam/`
>
