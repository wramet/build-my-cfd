...
> [!INFO] **สรุป Section 1**
> Section 1 establishes the mathematical foundation for two-phase flow with phase change, emphasizing the critical expansion source term in the continuity equation ($\nabla\cdot U = \dot{m}(1/\rho_v - 1/\rho_l)$). We covered design decisions including the Finite Volume Method, segregated solver approach, and refrigerant-specific considerations for R410A/R32 evaporators. Key concepts include volume fraction tracking, mass transfer modeling, and the importance of proper thermodynamic property handling.
