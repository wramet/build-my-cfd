...
> > **คำตอบเชิงลึก:**
> > SIMPLE เป็นอัลกอริทึมแบบ **Iterative** สำหรับปัญหา Steady-state ซึ่งการคำนวณแต่ละรอบใช้ค่าความดันจากรอบก่อนหน้า ($p^n$) ในการทำนายความเร็ว ($U^*$) การเปลี่ยนแปลงของความดันและความเร็วในแต่ละรอบอาจรุนแรงจนทำให้การคำนวณลู่ออก (Diverge) ดังนั้นจึงต้องใช้ **Under-Relaxation** ($\alpha_U, \alpha_p < 1$) เพื่อหน่วงการเปลี่ยนแปลงและรักษาเสถียรภาพ
> >
