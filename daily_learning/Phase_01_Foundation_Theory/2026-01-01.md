...
ในวิธี Volume of Fluid (VOF) เราไม่ได้ติดตามแต่ละเฟสแยกกัน แต่ติดตาม **เศษส่วนปริมาตร (Volume Fraction)**$\alpha$ซึ่งกำหนดให้:*$\alpha =1$: เซลล์นั้นเป็นของเหลวทั้งหมด (liquid)
