...
| `losortAddr()` | `labelList` | `nInternalFaces` | Permutation list ที่ Sort Faces โดยหลักตาม Owner Cell สิ่งนี้ช่วยให้ Ro-Wise Traversal มีประสิทธิภาพ สำหรับการดำเนินการที่ต้องการเข้าถึง Faces ทั้งหมดที่เป็นของ Cell ที่ระบุ |
