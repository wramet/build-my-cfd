...
> 📖 **อ่านเพิ่มเติม:** [[supplementary/ldumatrix_implementation_guide|LduMatrix Implementation Guide]]
> 
> ไฟล์อธิบายรายละเอียดเชิงลึกเกี่ยวกับ:
> - Step-by-step assembly process พร้อม visual examples
> - ความแตกต่างระหว่าง OpenFOAM `fvMatrix` vs `LduMatrix` ของเรา
> - Non-orthogonal correction และเหตุผลที่เราข้าม Phase 1
