...
> [!TIP] **Physical Analogy: The "Hot Air Balloon" Effect (ผลกระทบอลลูนร้อน)**
>
> ลองจินตนาการว่าของไหลร้อนเป็นเหมือน **บอลลูน** ที่ถูกปล่อยใต้น้ำ:
> 1.   **Heating:** เมื่อของไหลได้รับความร้อน มันจะขยายตัว (Density ลดลง)
> 2.  **Rising:** ของไหลที่เบากว่า (Hot) จะถูกแรงโน้มถ่วงดึงดูดน้อยกว่าของไหลที่หนักกว่า (Cold) รอบๆ จึง "ลอยตัว" ขึ้นด้านบนเหมือนลูกบอล
> 3.  **Circulation:** ของไหลเย็นพยายามเข้ามาแทนที่ที่ว่างข้างล่าง ทำให้เกิดวงจรการไหลวน (Convection Current) โดยไม่ต้องใช้ปั๊มเลย!
>
> **หัวใจสำคัญ:** แรงขับเคลื่อนคือ **แรงโน้มถ่วง ($\mathbf{g}$)** คูณกับ **ความต่างศักย์ของความหนาแน่น ($\Delta \rho$)** ถ้าไม่มีแรงโน้มถ่วง (เช่น ในอวกาศ) Natural Convection ก็จะไม่เกิดขึ้น!
...
1. **ถ้าเราต้มน้ำในอวกาศ (Zero Gravity) น้ำจะเดือดและหมุนวนเหมือนบนโลกไหม?**
   <details>
   <summary>เฉลย</summary>
   **ไม่เหมือน** เพราะ Natural Convection อาศัยแรงโน้มถ่วง ($g$) ในการแยกชั้นน้ำร้อน (เบา) กับน้ำเย็น (หนัก) ในอวกาศ $g=0$ น้ำร้อนที่ก้นหม้อจะไม่ลอยขึ้น แต่จะร้อนจัดอยู่กับที่จนกลายเป็นไอ (Conduction only) ซึ่งอาจทำให้หม้อไหม้ได้!
   </details>

2. **ทำไม Boussinesq Approximation ถึง "ประหยัดเวลาคำนวณ" กว่า Full Compressible Solver?**
   <details>
   <summary>เฉลย</summary>
   เพราะ Boussinesq มองว่าความหนาแน่น ($\rho$) เป็น **ค่าคงที่** ในสมการ Continuity และ Momentum (เทอม Inertia) ทำให้ Solver ไม่ต้องเสียเวลาแก้สมการอัดตัว (Compressibility) ที่ซับซ้อน หรือจัดการกับคลื่นเสียง (Acoustic waves) มีแค่เทอมแรงลอยตัวเท่านั้นที่แอบเปลี่ยน $\rho$ ตามอุณหภูมิ
   </details>

3. **Ra (Rayleigh Number) บอกอะไรเรา? ถ้า Ra ต่ำมากๆ จะเกิดอะไรขึ้น?**
   <details>
   <summary>เฉลย</summary>
   Ra บอกอัตราส่วนของ **แรงลอยตัว** ต่อ **แรงหนืด x การแพร่ความร้อน**
   - ถ้า $Ra$ ต่ำมากๆ (< 10³) แรงหนืดชนะขาดลอย ของไหลจะ **"หนืดเกินกว่าจะลอยไหว"** ความร้อนจะถ่ายเทผ่านการนำ (Conduction) เท่านั้น ของไหลจะนิ่งสนิท
   </details>
