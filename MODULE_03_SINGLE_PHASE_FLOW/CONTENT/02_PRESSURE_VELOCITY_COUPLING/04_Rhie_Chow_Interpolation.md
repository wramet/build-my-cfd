...
> [!TIP] **Physical Analogy: The Silent Classroom (ห้องเรียนที่เงียบงัน)**
>
> ลองจินตนาการถึงห้องเรียนที่นักเรียนนั่งเป็นตาราง (Grid):
>
> 1.  **The Problem (Checkerboard):** นักเรียน (Cell P) ต้องการเดาคะแนนสอบของตัวเองโดยดูจากเพื่อนทางซ้าย (W) และขวา (E) เท่านั้น ถ้าเพื่อนทางซ้ายได้ 100 และขวาได้ 100 นักเรียน P อาจจะเดาว่าตัวเองก็ได้ 100 ด้วย โดยไม่ดูข้อสอบตัวเองจริงๆ
>     - ถ้าเกิดสถานการณ์ที่คะแนนเป็น 100 (W) - 0 (P) - 100 (E) - 0 (EE)...
>     - การหาค่าเฉลี่ยจากเพื่อนข้างๆ ($100+100/2 = 100$) จะมองไม่เห็นความผิดปกติที่ตัวเองได้ 0
>     - นี่คือสาเหตุที่ Solver อาจจะ "คิดว่า" ทุกอย่างปกติ ทั้งที่ค่าความดันกระโดดขึ้นลงแบบบ้าคลั่ง
>
> 2.  **The Solution (Rhie-Chow):** ครู (Rhie-Chow) เดินมาบอกว่า "ห้ามดูแค่เพื่อนข้างๆ ให้ดูข้อสอบตัวเองด้วย!"
>     - Rhie-Chow เพิ่มเทอมพิเศษที่เปรียบเทียบ "เกรเดียนต์ที่หน้าตัด" กับ "เกรเดียนต์เฉลี่ย"
>     - เทอมนี้ทำหน้าที่เหมือน **Smoothing Filter** หรือ "ตัวหน่วง" ที่จะทำงานทันทีที่เห็นความต่างแบบกระโดด (Oscillation) และเกลี่ยมันให้เรียบ
...
1. **ทำไม Staggered Grid ถึงไม่เจอปัญหา Checkerboard pressure?**
   <details>
   <summary>เฉลย</summary>
   เพราะใน Staggered Grid ความเร็วถูกเก็บไว้ที่หน้าเซลล์ (Face) อยู่แล้ว ซึ่งตรงกับตำแหน่งที่ความดัน (ที่ Center) จะส่งแรงขับเคลื่อนพอดี ($\partial p / \partial x$ ใช้ $p_{i}$ และ $p_{i+1}$ ขนาบข้างความเร็ว $u_{i+1/2}$) จึงไม่จำเป็นต้องใช้การ Interpolate ข้ามเซลล์ที่ทำให้เกิดจุดบอด
   </details>

2. **ถ้าเราปิดการใช้งาน Rhie-Chow (สมมติว่าทำได้) ผลลัพธ์ที่น่าจะเกิดขึ้นทันทีคืออะไร?**
   <details>
   <summary>เฉลย</summary>
   การแกว่งของสนามความดันแบบสลับฟันปลา (High-frequency oscillation) และ Solution อาจจะ Ludoow (Diverge) อย่างรวดเร็ว
   </details>

3. **ใน OpenFOAM ฟังก์ชันใดที่เป็นตัวบอกว่าเรากำลังใช้ Rhie-Chow?**
   <details>
   <summary>เฉลย</summary>
   `fvc::flux(HbyA)` ซึ่งคำนวณ Mass flux ที่หน้าเซลล์ โดยมีเทอม Correction ของ Rhie-Chow แฝงอยู่ภายใน
   </details>
