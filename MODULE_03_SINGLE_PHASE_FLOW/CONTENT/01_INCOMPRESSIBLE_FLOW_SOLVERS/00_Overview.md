...
```
> **Figure 1:** แผนผังลำดับขั้นตอนการทำงานของอัลกอริทึม SIMPLE (SIMPLE Algorithm Workflow) สำหรับการแก้ปัญหาการไหลแบบอัดตัวไม่ได้ในสภาวะคงที่ ซึ่งแสดงกระบวนการวนซ้ำตั้งแต่การทำนายโมเมนตัม การแก้ไขความดันและความเร็ว ไปจนถึงการตรวจสอบการลู่เข้าของระบบความปลอดภัยทางฟิสิกส์ไม่ส่งผลกระทบต่อความเร็วในการจำลอง ผ่านการใช้พลังของ C++ Template Metaprogramming ในการตรวจสอบความสอดคล้องทางมิติทั้งหมดที่ขั้นตอนการคอมไพล์โปรแกรมเพียงครั้งเดียว
...
relaxationFactors {
    fields {
        p               0.3;    // Under-Relaxation ของความดัน
        rho             0.8;    // Under-Relaxation ของความหนาแน่น
    }
    equations {
        U               0.7;    // Under-Relaxation ของความเร็ว
        k               0.6;    // พลังงานจลน์ Turbulence
        epsilon         0.6;    // อัตราการสลายตัวของ Turbulence
    }
}
```
...
// controlDict
residualControl {
    p               1e-6;      // เกณฑ์ Convergence ของความดัน
    U               1e-6;      // เกณฑ์ Convergence ของความเร็ว
    "(k|epsilon|omega)" 1e-5;  // สมการ Turbulence
}
