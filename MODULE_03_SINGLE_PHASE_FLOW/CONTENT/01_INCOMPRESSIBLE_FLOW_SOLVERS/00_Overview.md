...
> [!TIP] **Physical Intuition: สัญชาตญาณทางฟิสิกส์**
>
> **The Crowded Party Analogy (เปรียบเทียบกับงานปาร์ตี้ที่แออัด)**
>
> ลองจินตนาการถึงห้องงานปาร์ตี้ที่เต็มไปด้วยผู้คนจนแน่น (Incompressible):
> - **Density คงที่:** ถ้ามีคนเดินเข้ามาทางประตูหน้า 1 คน จะต้องมีคนเดินออกทางประตูหลัง 1 คน *ทันที* เพื่อรักษาระดับความหนาแน่นในห้องให้เท่าเดิม
> - **Speed of Sound = Infinity:** ในทางทฤษฎี ข้อมูลข่าวสาร (เช่น แรงดัน) เดินทางด้วยความเร็วอนันต์ ถ้าคุณผลักคนที่อยู่หน้าประตู คนที่อยู่สุดห้องจะรู้สึกถึงแรงผลักแทบจะทันที เพราะไม่มี "ช่องว่าง" ให้บีบอัดได้
>
> นี่คือเหตุผลว่าทำไมสมการ $\nabla \cdot \mathbf{u} = 0$ ถึงทรงพลังมาก มันบอกว่า "สิ่งที่เข้ามา ต้องเท่ากับสิ่งที่ออกไป" ในทุกๆ จุดและทุกๆ เวลา
...
> [!TIP] **Physical Intuition: สัญชาตญาณทางฟิสิกส์**
>
> **The Coupled Train Analogy (เปรียบเทียบกับขบวนรถไฟที่เชื่อมติดกัน)**
>
> - **Compressible Flow (การจราจรบนถนน):** ถ้ารถคันหน้าเบรก รถคันหลังยังวิ่งต่อได้สักพักก่อนจะเบรกตาม ทำให้เกิดความหนาแน่นของรถเพิ่มขึ้นเฉพาะจุด (Traffic jam)
> - **Incompressible Flow (ขบวนรถไฟ):** รถทุกตู้เชื่อมติดกันด้วยเหล็กแข็ง ถ้ารถหัวขบวนเบรก รถท้ายขบวนต้องหยุด *พร้อมกันทันที*
>
> **บทบาทของ Pressure:** ใน Incompressible flow, **Pressure** ทำหน้าที่เหมือน "แท่งเหล็ก" ที่ส่งผ่านแรงสื่อสารระหว่างอนุภาคของไหลอย่างรวดเร็ว เพื่อบังคับให้ของไหลเคลื่อนที่ไปพร้อมกันโดยไม่เกิดการอัดตัว (Continuity Constraint) ถ้าไม่มี Pressure คอยกำกับ ของไหลก็จะบีบอัดตัวได้เหมือนฟองน้ำ
...
ลองตอบคำถามเหล่านี้เพื่อตรวจสอบความเข้าใจของคุณ:

1. **ทำไมเราถึงต้องมีอัลกอริทึมอย่าง SIMPLE หรือ PISO? ทำไมไม่แก้หา Pressure ไปตรงๆ?**
   <details>
   <summary>เฉลย</summary>
   เพราะใน Incompressible flow ไม่มีสมการสถานะ (Equation of State) ที่เชื่อมโยงความดันกับความหนาแน่นโดยตรง และไม่มีสมการวิวัฒนาการ (Evolution Equation) สำหรับความดัน เราจึงต้องสร้างสมการความดันขึ้นมาจากการบังคับให้สนามความเร็วเป็นไปตามกฎทรงมวล (Continuity Equation)
   </details>

2. **ความแตกต่างหลักระหว่าง SIMPLE และ PISO คืออะไร?**
   <details>
   <summary>เฉลย</summary>
   SIMPLE ใช้สำหรับ Steady-state simulation และใช้ Under-relaxation เพื่อความเสถียร ในขณะที่ PISO ใช้สำหรับ Transient simulation และใช้การวนรอบแก้ไข (Correctors) หลายครั้งในหนึ่ง Time step เพื่อความแม่นยำทางเวลา
   </details>

3. **ถ้าค่า Residual ของความดัน (p) ลดลงต่ำมากแล้ว แต่ Lift Coefficient ($C_L$) ยังแกว่งอยู่ แสดงว่า Simulation ลู่เข้า (Converged) หรือไม่?**
   <details>
   <summary>เฉลย</summary>
   ยังไม่ถือว่า Converged อย่างสมบูรณ์ การดู Residual เพียงอย่างเดียวไม่เพียงพอ ต้องดูปริมาณทางกายภาพ (Integrals) อย่าง $C_L$ หรือ $C_D$ ด้วยว่านิ่งหรือยัง
   </details>
