...
> [!TIP] **Physical Analogy: The Atmosphere (ชั้นบรรยากาศ)**
>
> เปรียบเทียบ Boundary Layer กับการเดินทางจากพื้นดินขึ้นสู่ท้องฟ้า:
>
> 1.  **Viscous Sublayer ($y^+ < 5$) = "The Traffic Jam on Ground":**
>     - เหมือนรถที่ติดอยู่บนถนน เคลื่อนที่ช้าๆ อย่างเป็นระเบียบ (Laminar)
>     - แรงเสียดทานสูงมาก (Viscous force dominant)
>     - *ต้องใช้ Mesh ละเอียดมากเพื่อจับภาพรถทีละคัน*
>
> 2.  **Buffer Layer ($5 < y^+ < 30$) = "The Takeoff Zone":**
>     - เครื่องบินกำลังทะยานขึ้น สภาพอากาศแปรปรวน ผสมปนเปกันระหว่างความเป็นระเบียบและความปั่นป่วน
>     - *ยากที่สุดในการจำลอง เพราะไม่ใช่อย่างใดอย่างหนึ่ง*
>
> 3.  **Log-Law Region ($y^+ > 30$) = "Cruising Altitude":**
>     - เครื่องบินบินเร็ว ลมพัดแรง (Turbulent) อิสระจากแรงเสียดทานพื้นผิว
>     - พฤติกรรมทำนายได้ง่ายด้วยสูตรคณิตศาสตร์ (Logarithmic profile)
>
> **Wall Function คืออะไร?**
> คือการ **"มองผ่านกล้องโทรทรรศน์"** จากความสูง (Log-law region) ลงมาที่พื้น โดยใช้สูตรคำนวณว่า "ถ้าลมข้างบนเร็วเท่านี้ แรงเสียดทานข้างล่างน่าจะเป็นเท่าไหร่" แทนที่จะลงไปวัดรถทีละคันที่พื้นดิน (ซึ่งประหยัดงบกว่ามาก!)
...
1. **ทำไมเราถึงต้องการ $y^+ \approx 1$ สำหรับ Wall-Resolved LES/DNS?**
   <details>
   <summary>เฉลย</summary>
   เพื่อจับภาพ Eddies (กระแสหมุนวน) ขนาดเล็กที่สุดที่เกิดขึ้นใน Viscous Sublayer ซึ่งเป็นจุดกำเนิดของ Turbulence ถ้า Mesh หยาบไป เราจะพลาด "จุดเริ่มต้น" ของความปั่นป่วนทั้งหมด
   </details>

2. **ถ้าใช้ Wall Function ($y^+ > 30$) แต่ Mesh เผลอละเอียดเกินไปจน $y^+ = 5$ จะเกิดอะไรขึ้น?**
   <details>
   <summary>เฉลย</summary>
   จะเกิดความผิดพลาด เพราะ Wall Function (สูตร Log-law) ถูกออกแบบมาสำหรับโซน $y^+ > 30$ การนำไปใช้ใน Buffer Layer ($y^+ \approx 5$) ซึ่งสูตร Log-law ไม่เป็นจริง จะทำให้ทำนายแรงเสียดทาน (Shear Stress) ผิดพลาดได้
   </details>

3. **ทำไม k-omega SST ถึงเป็นที่นิยมสำหรับ Flow Separation?**
   <details>
   <summary>เฉลย</summary>
   เพราะมันผสมข้อดีของ $k-\omega$ (แม่นยำใกล้ผนัง) และ $k-\epsilon$ (แม่นยำใน Free stream) ทำให้สามารถทำนายจุด Boundary Layer Separation ได้แม่นยำกว่าโมเดลเดี่ยวๆ
   </details>