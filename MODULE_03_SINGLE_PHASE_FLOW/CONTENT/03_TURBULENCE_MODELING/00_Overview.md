...
> [!TIP] **Physical Intuition: What is Turbulence?**
>
> ลองจินตนาการถึง **ควันธูป (Incense Smoke)** ที่ลอยขึ้นมาในอากาศนิ่ง:
> 1. **Laminar Region:** ช่วงแรกควันจะลอยขึ้นเป็นเส้นตรงเรียบๆ สวยงาม (Smooth, Orderly)
> 2. **Transition:** สักพักเส้นควันจะเริ่มแกว่ง (Instability)
> 3. **Turbulent Region:** สุดท้ายควันจะแตกกระจาย ม้วนตัวยุ่งเหยิง (Chaotic, Mixing)
>
> **ทำไม Turbulence ถึงสำคัญ?**
> - **ข้อเสีย:** เพิ่มแรงต้าน (Drag) ให้กับรถยนต์หรือเครื่องบิน
> - **ข้อดี:** ช่วยผสมสาร (Mixing) ได้ดีเยี่ยม ลองนึกถึงการคนกาแฟ ถ้ากระแสน้ำในแก้วเป็น Laminar กาแฟกับนมคงแยกชั้นกันตลอดไป ความปั่นป่วนช่วยให้มันเข้ากันได้!
...
> [!TIP] **Conceptual Analogy: The Camera & The Photo (กล้องและภาพถ่าย)**
>
> เปรียบเทียบการถ่ายภาพแม่น้ำที่ไหลเชี่ยว:
>
> 1.  **DNS (Direct Numerical Simulation) = High-Speed Video 4K:**
>     - คุณถ่ายวิดีโอความละเอียดสูง เห็นหยดน้ำทุกหยด การกระเซ็นทุกจุด ชัดเจนทุกวินาที
>     - **Cost:** ไฟล์ใหญ่มาก ต้องใช้คอมพิวเตอร์ตัดต่อระดับเทพ
>
> 2.  **LES (Large Eddy Simulation) = Standard Video (720p) with Blur filter:**
>     - คุณเห็นคลื่นลูกใหญ่ๆ การม้วนตัวหลักๆ ชัดเจน แต่ฟองอากาศเล็กๆ ถูกเบลอไป (Filtered/Modeled)
>     - **Cost:** ไฟล์เล็กลง แต่ยังเห็นการเคลื่อนไหวสำคัญครบถ้วน
>
> 3.  **RANS (Reynolds-Averaged Navier-Stokes) = Long-Exposure Photo:**
>     - คุณตั้งกล้องถ่ายแบบเปิดชัตเตอร์ค้างไว้นานๆ (Long exposure)
>     - ภาพที่ได้คือ "สายน้ำนุ่มๆ" ที่นิ่งสนิท (Steady State) คุณไม่เห็นหยดน้ำที่กระเด็น (Fluctuations) แต่คุณเห็น "แนวโน้ม" ว่าน้ำไหลไปทางไหน
>     - **Cost:** ไฟล์รูปภาพใบเดียว ขนาดเล็ก ประมวลผลเร็วมาก! (นี่คือเหตุผลที่วิศวกรชอบใช้ RANS)
...
1. **ทำไมเราไม่ใช้ DNS สำหรับการออกแบบรถยนต์ในอุตสาหกรรม?**
   <details>
   <summary>เฉลย</summary>
   เพราะ DNS ต้องใช้ Grid ที่ละเอียดถึงระดับ Kolmogorov scale (เล็กเท่าฝุ่นผง) เพื่อจับทุกรายละเอียดของ Turbulence ซึ่งต้องใช้ Mesh จำนวนมหาศาล (ระดับพันล้านหรือล้านล้านเซลล์) และเวลาคำนวณนานเกินกว่าจะรอไหวในกระบวนการออกแบบจริง
   </details>

2. **RANS Model (เช่น k-epsilon) "เฉลี่ย" อะไร?**
   <details>
   <summary>เฉลย</summary>
   เฉลี่ย **ตามเวลา (Time-averaged)** หรือ Ensemble-averaged ถ้าเราวัดความเร็วที่จุดหนึ่งในการไหลแบบ RANS ค่าที่ได้คือค่า "นิ่งๆ" (Mean Velocity) ไม่ใช่ค่าที่แกว่งไปมาจริงๆ
   </details>

3. **k ใน k-epsilon Model คืออะไร และบอกอะไรเรา?**
   <details>
   <summary>เฉลย</summary>
   $k$ คือ **Turbulent Kinetic Energy** (พลังงานจลน์ของความปั่นป่วน) บอกถึง "ความแรง" ของการผันผวน ($u'$) ถ้า $k$ สูง แปลว่าตรงนั้นมีลมหมุนวนรุนแรง (Fluctuation สูง)
   </details>
