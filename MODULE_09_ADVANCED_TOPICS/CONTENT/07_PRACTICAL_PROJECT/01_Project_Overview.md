...
<details>
<summary>1. ในทางฟิสิกส์ ค่าดัชนี Power-Law ($n$) ที่น้อยกว่า 1 หมายถึงพฤติกรรมของของไหลแบบใด?</summary>

**คำตอบ:** หมายถึงพฤติกรรม **Shear-thinning (Pseudoplastic)** ซึ่งความหนืดของของไหลจะ **ลดลง** เมื่ออัตราการเฉือน (Shear Rate) เพิ่มขึ้น (ตัวอย่างเช่น เลือด หรือ สีทาบ้าน)
</details>

<details>
<summary>2. จากแผนผังการทำงาน (Roadmap) ทำไมขั้นตอน "Factory Registration" (การลงทะเบียนโรงงาน) จึงจำเป็น?</summary>

**คำตอบ:** เพื่อให้โมเดลใหม่ที่สร้างขึ้น **สามารถถูกเลือกใช้งานได้ในขณะรัน (Runtime)** ผ่านไฟล์ `transportProperties` โดยที่ผู้ใช้ **ไม่จำเป็นต้องแก้ไขหรือคอมไพล์โปรแกรม Solver ใหม่** (เช่น `simpleFoam`) ซึ่งเป็นหัวใจสำคัญของความยืดหยุ่นใน OpenFOAM
</details>

## 📚 เอกสารที่เกี่ยวข้อง (Related Documents)

*   **ภาพรวม:** [00_Overview.md](00_Overview.md) - ภาพรวมของโปรเจกต์ปฏิบัติจริง
*   **ถัดไป:** [02_Model_Development_Rationale.md](02_Model_Development_Rationale.md) - เหตุผลในการพัฒนา: ทำไมต้องสร้างโมเดลเอง?