...
<details>
<summary>1. ทำไม "Expression Splitting" (การแยกสมการเดียวออกเป็นหลายตัวแปรย่อย) จึงถือเป็น Anti-pattern ที่ทำลายประสิทธิภาพใน OpenFOAM?</summary>

**คำตอบ:** เพราะมันบังคับให้มีการ **จองหน่วยความจำ (Memory Allocation)** สำหรับทุกตัวแปรคั่นกลาง, ทำลาย **Cache Locality** จากการต้องอ่าน/เขียนหน่วยความจำหลายรอบ, และป้องกันไม่ให้คอมไพเลอร์ทำการ **Loop Fusion** ซึ่งส่งผลให้การทำงานช้าลงและเปลืองหน่วยความจำอย่างมาก
</details>

<details>
<summary>2. อันตรายของการใช้ลูป `forAll` เพื่อกำหนดค่าฟิลด์ด้วยตัวเอง (Manual Iteration) แทนการใช้ Field Algebra (เช่น `U = ...`) คืออะไร?</summary>

**คำตอบ:** การวนลูปเองมักจะอัปเดตเฉพาะ **Internal Field** แต่ละเลยการอัปเดต **Boundary Fields** (ขอบเขต) ทำให้สถานะของฟิลด์ไม่สอดคล้องกัน (Inconsistent), การคำนวณ Flux ผิดพลาด, และอาจนำไปสู่ความไม่เสถียรทางตัวเลข (Numerical Instability) ในที่สุด
</details>

## 📚 เอกสารที่เกี่ยวข้อง (Related Documents)

*   **ก่อนหน้า:** [05_Design_Patterns_and_Trade-offs.md](05_Design_Patterns_and_Trade-offs.md) - รูปแบบการออกแบบและข้อแลกเปลี่ยน
*   **ถัดไป:** [07_Appendices.md](07_Appendices.md) - ภาคผนวกและข้อมูลประกอบเพิ่มเติม