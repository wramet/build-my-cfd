...
ในบทถัดไป เราจะตรวจสอบว่ากลไกเหล่านี้ทำงานร่วมกันอย่างไรในการจัดการหน่วยความจำแบบ end-to-end

## 🧠 ทดสอบความเข้าใจ (Concept Check)

<details>
<summary>1. ทำไมตัวแปร `refCount_` ในคลาส `refCount` จึงต้องประกาศเป็น `mutable`?</summary>

**คำตอบ:** เพื่อให้ Function `ref()` และ `unref()` สามารถเปลี่ยนค่าตัวนับได้ **แม้กระทั่งกับออบเจกต์ที่เป็น `const`** (Logical Constness) การนับ Reference เป็นเพียงสถานะภายในเพื่อจัดการหน่วยความจำ ไม่ได้เปลี่ยนแปลงค่าทางคณิตศาสตร์หรือความหมายของออบเจกต์ จึงต้องใช้ `mutable` เพื่อรักษาหลักการ Const-Correctness
</details>

<details>
<summary>2. ตัวแปร `event_` ใน `objectRegistry` มีหน้าที่อะไร และช่วยเรื่องประสิทธิภาพอย่างไร?</summary>

**คำตอบ:** ใช้สำหรับ **ติดตามการเปลี่ยนแปลง (Change Tracking)** ของ Registry (เช่น การเพิ่มหรือลบออบเจกต์) โดยการเพิ่มค่า Counter ออบเจกต์อื่นๆ สามารถเก็บค่า `event_` ล่าสุดที่เคยเห็นไว้เปรียบเทียบ เพื่อรู้ว่าข้อมูลใน Registry เปลี่ยนไปหรือไม่ (O(1) Check) โดยไม่ต้องเสียเวลา Scan Registry ทั้งหมดเพื่อตรวจสอบ Cache Invalidation
</details>

## 📚 เอกสารที่เกี่ยวข้อง (Related Documents)

*   **ก่อนหน้า:** [02_Memory_Syntax_and_Design.md](02_Memory_Syntax_and_Design.md) - ไวยากรณ์และการออกแบบ
*   **ถัดไป:** [04_Mathematical_Foundations.md](04_Mathematical_Foundations.md) - รากฐานทางคณิตศาสตร์ของการจัดการหน่วยความจำ