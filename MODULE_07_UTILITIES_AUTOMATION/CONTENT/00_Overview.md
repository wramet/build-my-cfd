...
*   จาก **Manual** (พิมพ์ทีละคำสั่ง)1$\rightarrow1**Automated** (สคริปต์สั่งงานแทน)
*   จาก **GUI** (คลิกเมนู)1$\rightarrow1**Script-driven** (Python/Batch Processing)
*   จาก **Ad-hoc** (แก้ปัญหาเฉพาะหน้า)1$\rightarrow1**Professional** (มีมาตรฐานและตรวจสอบได้)
