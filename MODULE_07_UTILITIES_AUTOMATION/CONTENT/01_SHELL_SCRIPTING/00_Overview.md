...
> [!TIP] **เปรียบเทียบ: โรงงานประกอบรถยนต์ (The Assembly Line Analogy)**
> 
> ลองจินตนาการว่าคุณต้องสร้างรถยนต์ 100 คัน:
> 
> 1.  **Manual Workflow (ช่างฝีมือ):** ช่างหนึ่งคนค่อยๆ ตอกตะปู ขันน็อต ประกอบรถทีละคันด้วยมือ ถ้าช่างเหนื่อยหรือเผลอ รถคันที่ 50 อาจจะลืมใส่น็อตล้อ และกว่าจะเสร็จใช้เวลาเป็นปี
> 2.  **Automated Workflow (สายพานการผลิต):** คุณสร้าง "ระบบหุ่นยนต์" (Scripts) ที่ทำหน้าที่ขันน็อตตำแหน่งเดิมเป๊ะๆ ทุกครั้ง ไม่ว่าจะทำ 1 คัน หรือ 1,000 คัน คุณภาพจะเหมือนกัน 100% และเสร็จในเวลาไม่กี่นาที
>
> ใน CFD:
> - **Chassis** = Geometry/Mesh
> - **Engine** = Solver Settings
> - **Assembly Robots** = Shell/Python Scripts
...
- [[../../MODULE_02_MESHING_AND_CASE_SETUP/00_Navigator]] - พื้นฐานการสร้างเมชใน OpenFOAM
- [[../../MODULE_03_SINGLE_PHASE_FLOW/00_Navigator]] - พื้นฐาน Solvers และการตั้งค่า

---

## 🧠 ตรวจสอบความเข้าใจ (Concept Check)

1. **ถาม:** "Decomposition" ในบริบทของ Parallel Computing คืออะไร?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b> คือการแบ่งโดเมนการคำนวณขนาดใหญ่ (Large Mesh) ออกเป็นชิ้นย่อยๆ (Subdomains) เพื่อแจกจ่ายให้ Processor หลายตัวช่วยกันคำนวณพร้อมกัน
   </details>

2. **ถาม:** ทำไมเราต้อง "Reconstruct" ผลลัพธ์หลังจากการรันแบบขนาน?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b> เพราะผลลัพธ์จากการรันแบบขนานจะถูกแยกเก็บในโฟลเดอร์ของแต่ละ Processor (`processor0`, `processor1`, ...) เราต้องรวมข้อมูลเหล่านี้กลับมาเป็นไฟล์เดียวเพื่อให้โปรแกรม Post-processing (เช่น ParaView) อ่านได้ง่ายและเห็นภาพรวมทั้งโดเมน
   </details>

3. **ถาม:** ในการทำ Parametric Study ถ้าเราเปลี่ยนความเร็วลมเข้า (Inlet Velocity) 10 ค่า เราควรใช้ Script ทำอะไรบ้าง?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b>
   1. **Clone Case:** สร้างโฟลเดอร์เคสใหม่ 10 โฟลเดอร์จากเคสต้นแบบ
   2. **Modify Dictionary:** แก้ไขไฟล์ `0/U` ในแต่ละโฟลเดอร์ให้มีค่าความเร็วตามต้องการ
   3. **Run Solver:** สั่งรัน Solver ในแต่ละเคส (อาจจะรันต่อคิวหรือขนานกัน)
   4. **Extract Results:** ดึงค่าที่สนใจ (เช่น Drag/Lift) จากแต่ละเคสมาสรุป
   </details>