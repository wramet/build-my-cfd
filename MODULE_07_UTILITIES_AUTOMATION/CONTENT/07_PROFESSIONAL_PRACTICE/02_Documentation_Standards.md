...
> [!TIP] **เปรียบเทียบมาตรฐานเอกสาร (Analogy)**
> ให้เปรียบเทียบการทำ Documentation เหมือนกับ **"การเขียนแผนที่ลายแทงสมบัติ (Treasure Map)"**
> - **Code/Case Files** คือ "เส้นทางเดินในป่า" ที่เราถางไว้แล้ว
> - **Comments/Inline Docs** คือ "ป้ายบอกทาง" ที่ปักไว้ตามจุดแยก เพื่อบอกว่าทำไมถึงเลี้ยวซ้ายหรือขวา
> - **Technical Report/README** คือ "แผนที่ภาพรวม" ที่บอกจุดเริ่มต้น จุดสิ้นสุด อุปสรรคที่ต้องระวัง และสิ่งที่ผู้เดินทางจะได้รับเมื่อไปถึง
> ถ้าไม่มีแผนที่หรือป้ายบอกทาง คนที่มาทีหลัง (หรือแม้แต่ตัวเราเองในอนาคต) อาจจะหลงทางในป่าโค้ดที่เราสร้างขึ้นเองจนหาทางออกไม่เจอ
...
...
## 📈 Results
> **[ตัวอย่างผลลัพธ์]**: ส่วนนี้ควรแสดงผลการจำลองที่สำคัญ เช่น กราฟเปรียบเทียบหรือค่าสัมประสิทธิ์ต่างๆ

- Drag coefficient: `0.345 (Simulation) vs 0.340 (Exp.) -> Error 1.47%`
- Lift coefficient: `0.002 (Simulation) ~ 0 (Theoretical Symmetry)`
- Convergence: `Residuals dropped below 1e-6 within 2500 iterations`
...
1. **ถาม:** ทำไมการระบุหน่วย (Units) ในเอกสารคู่มือการใช้งาน (Manual) หรือ Doxygen Comments ถึงมีความสำคัญอย่างยิ่งสำหรับโปรแกรม CFD?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b> เพราะความผิดพลาดเรื่องหน่วย (เช่น การสับสนระหว่าง mm กับ m) เป็นสาเหตุหลักที่ทำให้ผลการจำลองผิดพลาดอย่างรุนแรง การระบุหน่วยให้ชัดเจนช่วยลดความเสี่ยงนี้และช่วยให้ผู้ใช้งานป้อนค่าได้ถูกต้องตามสมมติฐานของโปรแกรม
   </details>

2. **ถาม:** ในการเขียนรายงานผลการจำลอง (Technical Report) ทำไมเราถึงต้องใส่ข้อมูลเรื่อง "Mesh Quality" และ "Grid Convergence Study" ลงไปด้วย?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b> เพื่อยืนยันความน่าเชื่อถือของผลลัพธ์ (Reliability & Independence) ข้อมูลเหล่านี้แสดงให้เห็นว่าผลการคำนวณไม่ได้เกิดจากความผิดพลาดของเมช (Numerical Artifacts) และผลลัพธ์มีความแม่นยำเพียงพอที่ไม่ขึ้นกับขนาดของเมช
   </details>

3. **ถาม:** จงอธิบายความแตกต่างระหว่าง `@brief` และ Detailed Description ในการเขียน Doxygen Comments?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b> `@brief` เป็นการสรุปหน้าที่ของฟังก์ชันหรือคลาสสั้นๆ ใน 1-2 ประโยค เพื่อให้ผู้อ่านเข้าใจภาพรวมอย่างรวดเร็ว ส่วน Detailed Description จะอธิบายรายละเอียดเชิงลึก วิธีการทำงาน เงื่อนไขการใช้งาน ทฤษฎีที่เกี่ยวข้อง และตัวอย่าง Code usage
   </details>

4. **ถาม:** การใช้ Color Map แบบ "Rainbow" หรือ "Jet" ในการแสดงผล Contour Plot ถือเป็นข้อควรปฏิบัติที่ดีหรือไม่? เพราะอะไร?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b> **ไม่ดี** และควรหลีกเลี่ยง เพราะ Color Map แบบ Rainbow ไม่มีความสม่ำเสมอทางสายตา (Perceptually Uniform) ทำให้บางช่วงสีดูเปลี่ยนแปลงรุนแรงทั้งที่ค่าเปลี่ยนแปลงเพียงเล็กน้อย หรือบางช่วงสีกลืนกัน ทำให้ตีความข้อมูลผิดพลาดได้ ควรใช้ Color Map ที่มีความสม่ำเสมอ เช่น `viridis`, `magma`, หรือ `coolwarm` แทน
   </details>
