...
> [!TIP] เปรียบเทียบ: การตรวจเช็คพิมพ์เขียว vs การตรวจรับงานก่อสร้าง
> - **Verification (การตรวจสอบแบบ)**: เหมือนสถาปนิกที่ตรวจสอบ "พิมพ์เขียว" (Code/Math) ว่าเส้นตรงไหม มุมฉากไหม คำนวณรับน้ำหนักถูกตามสูตรไหม (ยังไม่ได้สร้างจริง)
> - **Validation (การตรวจรับงาน)**: เหมือนวิศวกรที่ไปหน้างานเพื่อดู "ตึกจริง" (Simulation Result) ว่าสร้างเสร็จแล้วถล่มไหม ใช้งานได้จริงตามวัตถุประสงค์ไหม (เทียบกับความจริง)
...
> **ตัวอย่างตารางผลลัพธ์ GCI (Sample GCI Table):**
> 
> | Mesh Level | Number of Cells | Characteristic Value ($\phi$) | Relative Error ($e$) | GCI (%) |
> | :--- | :--- | :--- | :--- | :--- |
> | 1 (Coarse) | 10,000 | 0.368 | - | - |
> | 2 (Medium) | 40,000 | 0.352 | 4.35% | 5.2% |
> | 3 (Fine) | 160,000 | 0.345 | 1.98% | 1.2% |
> 
> *หมายเหตุ: ค่า GCI ที่ลดลงเมื่อเมชละเอียดขึ้นแสดงถึงระดับความเชื่อมั่นที่สูงขึ้น*
...
1. **ถาม:** หากผลการทำ Grid Convergence Study พบว่าค่าไม่ลู่เข้าหาค่าคงที่ (Oscillate) ปัญหานี้จัดเป็นความล้มเหลวของ Verification หรือ Validation?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b> เป็นปัญหาของ <b>Verification</b> เพราะแสดงว่า Numerical Method หรือ Grid ยังไม่สามารถแก้สมการคณิตศาสตร์ได้อย่างถูกต้อง (Failed discretized solution) ยังไม่ได้ไปถึงขั้นเทียบกับฟิสิกส์จริง
   </details>

2. **ถาม:** Order of Accuracy บอกอะไรเกี่ยวกับความสัมพันธ์ระหว่างความผิดพลาดและขนาดเมช?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b> บอกว่า Error จะลดลงเร็วแค่ไหนเมื่อเราลดขนาดเมช เช่น หากเป็น Second-order ($p=2$) เมื่อลดขนาดเมชลง 2 เท่า ($h/2$) Error จะลดลง 4 เท่า ($(1/2)^2 = 1/4$)
   </details>

3. **ถาม:** Richardson Extrapolation มีข้อจำกัดสำคัญอะไรบ้าง?
   <details>
   <summary>เฉลย</summary>
   <b>ตอบ:</b> (1) ต้องใช้ผลลัพธ์จากเมชที่อยู่ในช่วง Asymptotic Range แล้วเท่านั้น (2) เมชต้องมีความคล้ายคลึงกันทางเรขาคณิต (Geometrically similar) และ (3) ผลเฉลยต้องมีความต่อเนื่อง (Smooth)
   </details>
