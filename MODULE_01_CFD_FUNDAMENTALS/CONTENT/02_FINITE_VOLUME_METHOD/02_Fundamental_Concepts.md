...
$$\int_V \nabla \cdot \mathbf{U} \, \mathrm{d}V = \int_S \mathbf{U} \cdot \mathrm{d}\mathbf{S} \tag{1.1}$$

> [!TIP]
> **Physical Intuition: ทฤษฎีบทของเกาส์ (Gauss's Theorem) คือ "เครื่องนับจำนวนคน"**
>
> ลองนึกถึง **ห้องประชุม (Control Volume)** ที่มีคนอยู่ข้างใน
>
> 1.  **ด้านซ้ายของสมการ ($\int_V \nabla \cdot \mathbf{U} \, \mathrm{d}V$)**: คือการพยายามนับว่า **มีความเปลี่ยนแปลงของความหนาแน่นคน** เกิดขึ้นที่จุดต่างๆ ภายในห้องรวมกันเท่าไหร่ (ซึ่งวัดยาก)
> 2.  **ด้านขวาของสมการ ($\int_S \mathbf{U} \cdot \mathrm{d}\mathbf{S}$)**: คือการไปยืนเฝ้าที่ **ประตูทุกบาน (Face/Surface)** แล้วนับจำนวนคนที่ **เดินเข้าและเดินออก**
>
> **Gauss's Theorem บอกว่า:** ถ้าคุณรู้อัตราคนที่เดินผ่านประตูเข้าออกสุทธิ (Surface Integral) คุณก็จะรู้ทันทีว่าจำนวนคนในห้องเปลี่ยนแปลงไปเท่าไหร่ (Volume Integral) โดยไม่ต้องไปไล่นับคนข้างในทีละจุด!
>
> นี่คือเหตุผลที่ FVM ชอบใช้วิธีนี้: เราแค่คำนวณ Flux ที่หน้า (Faces) ก็รู้พฤติกรรมของทั้ง Volume ได้
...
> - ดู [[05_Matrix_Assembly]] สำหรับการนำหลักการอนุรักษ์มาสร้างระบบสมการ
> - ดู [[06_OpenFOAM_Implementation]] สำหรับตัวอย่างโค้ดจริง
