...
graph LR
    ...
    %% Connections via Faces
    B --> F[Face 1] --> A
    C --> G[Face 2] --> A
    D --> H[Face 3] --> A
    E --> I[Face 4] --> A

    %% Styling using Classes (Cleaner Code)
...
> - [[02_Conservation_Laws]] - กฎการอนุรักษ์
> - [[03_Equation_of_State]] - สมการสถานะ
> - [[04_Dimensionless_Numbers]] - จำนวน无มิติ
...
> - [[08_Key_Points_to_Remember]] - ประเด็นสำคัญที่ต้องจำ
