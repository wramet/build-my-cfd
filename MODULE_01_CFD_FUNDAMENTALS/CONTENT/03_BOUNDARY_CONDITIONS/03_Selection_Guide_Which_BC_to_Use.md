...
| Outlet | `fixedValue` | — | Reference point (p = 0 gauge) |
...
**ทำไมต้องคู่กัน?**
- `freestreamVelocity` ปรับตัวตาม local flow direction (อาจไหลเข้าหรือออก)
- `freestreamPressure` ทำงานร่วมกันให้ pressure และ velocity consistent
- ใช้เฉพาะกับ far-field boundary ที่ห่างจาก object พอ (flow ไม่ถูกรบกวนมาก)
