...
> [!TIP] **Physical Analogy: The Traffic Report vs. GPS Tracker (รายงานจราจร vs. ติดตามรถ GPS)**
>
> เปรียบเทียบวิธีการมอง Multiphase Flow สองแบบหลัก:
>
> 1.  **Eulerian-Lagrangian (Discrete Phase):** เหมือน **"GPS Tracker"**
>     - คุณติดตามรถแต่ละคัน (Particle/Bubble) ว่าอยู่ที่ไหน ความเร็วเท่าไหร่
>     - เหมาะกับถนนโล่งๆ ที่มีรถไม่กี่คัน (Dilute flow) ถ้ามีรถล้านคัน คอมพิวเตอร์ระเบิดแน่!
>
> 2.  **Eulerian-Eulerian (Two-Fluid):** เหมือน **"Google Maps Traffic Density"**
>     - คุณไม่สนใจรถคันไหนเป็นคันไหน
>     - คุณสนใจแค่ว่า "ตรงแยกนี้ มีความหนาแน่นรถเก๋ง (Phase 1) กี่ % และรถบรรทุก (Phase 2) กี่ %"
>     - ทั้งรถเก๋งและรถบรรทุกถูกมองเป็น "กระแส" (Continuum) ที่ไหลแทรกซึมกัน
>     - เหมาะกับรถติดหนักๆ (Dense flow) หรืออุตสาหกรรมขนาดใหญ่ เพราะคำนวณได้เร็ว ไม่ขึ้นกับจำนวนรถ
...
## 🧠 14. Concept Check (ทดสอบความเข้าใจ)

1. **Volume Fraction ($\alpha$) บอกอะไรเรา? และข้อจำกัดทางคณิตศาสตร์คืออะไร?**
   <details>
   <summary>เฉลย</summary>
   บอกสัดส่วนปริมาตรที่เฟสนั้นครอบครองในแต่ละ Cell (เช่น 0.3 คือมีน้ำ 30%) ข้อจำกัดคือ ผลรวมของ Volume Fraction ของทุกเฟสใน Cell ต้องเท่ากับ 1 เสมอ ($\sum \alpha_k = 1$)
   </details>

2. **ทำไม Eulerian-Eulerian ถึงเหมาะกับ "Dense Flow" มากกว่า Lagrangian?**
   <details>
   <summary>เฉลย</summary>
   เพราะ Lagrangian ต้องคำนวณสมการการเคลื่อนที่ (F=ma) ของ **ทุกอนุภาค** ถ้ามีเป็นล้านหรือพันล้านอนุภาค (Dense) จะใช้พลังงานคอมพิวเตอร์มหาศาล แต่ Eulerian-Eulerian มองเป็น Continuum แค่แก้สมการ Navier-Stokes เพิ่มอีกชุดหนึ่ง ไม่ว่าจะมีกี่ล้านอนุภาค ต้นทุนการคำนวณก็เท่าเดิม
   </details>

3. **Interphase Momentum Transfer (เช่น Drag) มีความสำคัญอย่างไรในโมเดลนี้?**
   <details>
   <summary>เฉลย</summary>
   สำคัญมาก เพราะใน Eulerian-Eulerian เราแยกสมการโมเมนตัมของใครของมัน ถ้าไม่มีเทอม Drag (แรงต้าน) หรือ Interaction term เฟสทั้งสองจะไหลทะลุผ่านกันโดยไม่ส่งผลกระทบต่อกันเลย (Uncoupled) เทอมพวกนี้คือ "สะพาน" ที่ทำให้อากาศผลักน้ำ หรือทรายชะลอน้ำได้
   </details>