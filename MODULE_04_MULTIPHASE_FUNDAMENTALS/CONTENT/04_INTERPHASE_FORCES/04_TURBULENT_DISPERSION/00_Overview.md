...
> [!TIP] **Physical Analogy: Stirring Coffee with Milk (การคนกาแฟใส่นม)**
>
> ลองนึกภาพคุณหยดนมลงในกาแฟดำ:
>
> 1.  **No Stirring (Laminar):** นมจะลอยเป็นก้อนหรือแยกชั้นอยู่อย่างนั้น (No dispersion)
> 2.  **Stirring (Turbulent Dispersion):** เมื่อคุณเอาช้อนคน (ใส่ Turbulence เข้าไป) กระแสน้ำวนจากการคนจะพานมให้ "กระจายตัว" ไปทั่วแก้ว
>     -   แรงนี้จะพยายามเกลี่ยให้ความเข้มข้นของนม **สม่ำเสมอ** ทั่วทั้งแก้วเสมอ (จากที่เข้มข้นมาก -> ไปที่เจือจาง)
>     -   ถ้าคุณคนแรงขึ้น ($k$ สูง) นมก็จะกระจายตัวเร็วขึ้น ($F_{TD}$ สูง)
...
1. **แรง Turbulent Dispersion มีทิศทางอย่างไรเทียบกับความเข้มข้น (Concentration Gradient)?**
   <details>
   <summary>เฉลย</summary>
   มีทิศทาง **ตรงกันข้าม** กับ Gradient ของความเข้มข้น ($-\nabla \alpha$) กล่าวคือ มันจะผลักอนุภาคจากบริเวณที่มีความเข้มข้นสูง ไปสู่บริเวณที่มีความเข้มข้นต่ำ (High to Low) เสมอ คล้ายกับ Diffusion
   </details>

2. **ถ้า Flow เป็นแบบ Laminar ($k \approx 0$) แรง Turbulent Dispersion จะมีค่าเท่าไหร่?**
   <details>
   <summary>เฉลย</summary>
   จะมีค่าเป็น **ศูนย์** เพราะแรงนี้เกิดจากความผันผวนของความเร็ว (Velocity Fluctuations) ใน Turbulent eddies ถ้าไม่มี Turbulence ก็ไม่มีแรงนี้
   </details>

3. **ทำไมแรงนี้ถึงช่วยให้ Simulation "เสถียร" ขึ้น?**
   <details>
   <summary>เฉลย</summary>
   เพราะทางคณิตศาสตร์ แรงนี้ทำหน้าเสมือนเป็น **Diffusion Term** ในสมการขนส่งของ $\alpha$ ซึ่งช่วยเกลี่ยอุณหภูมิหรือความเข้มข้นไม่ให้เกิดค่าที่กระโดด (Sharp discontinuities) มากเกินไป ทำให้ Numerical Solver คำนวณได้ง่ายขึ้นและลดโอกาสเกิดพฤติกรรมที่ไม่พึงประสงค์ (Unboundedness)
   </details>