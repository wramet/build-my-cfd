...
> [!TIP] **Physical Analogy: The Curveball in Baseball (ลูกเบสบอลไซด์โค้ง)**
>
> ลองนึกภาพการขว้างลูกเบสบอล (หรือลูกไซด์โค้งในฟุตบอล):
>
> 1.  **Spinning Ball (Magnus Effect):** ลูกบอลที่หมุนจะลากอากาศไปด้านหนึ่งเร็วกว่าอีกด้าน เกิดความต่างศักย์ของความดัน ทำให้ลูกบอล "เลี้ยว" (Lift Force) ไปในทิศตั้งฉากกับการเคลื่อนที่
> 2.  **Bubble/Particle in Shear Flow (Shear Lift):** แม้ฟองอากาศอาจจะไม่ได้หมุนติ้วเหมือนลูกบอล แต่ "Shear Flow" (ความเร็วของเหลวสองฝั่งไม่เท่ากัน) ให้ผลลัพธ์เดียวกัน คือทำให้ความเร็วสัมพัทธ์และความดันสองฝั่งไม่เท่ากัน เกิดแรงยกผลักฟองไปด้านข้าง
>     -   **Small Bubbles ($C_L > 0$):** ถูกผลักเข้าหาผนัง (Wall-peaking)
>     -   **Large Wobbly Bubbles ($C_L < 0$):** ถูกผลักเข้าหากึ่งกลาง (Core-peaking) เหมือนลูกบอลที่ส่ายไปมาจนทิศทางแรงกลับด้าน
...
1.  **ทำไมโมเดล Tomiyama ถึงให้ค่าสัมประสิทธิ์แรงยก ($C_L$) เป็นลบสำหรับฟองอากาศขนาดใหญ่?**
    <details>
    <summary>เฉลย</summary>
    เมื่อฟองอากาศมีขนาดใหญ่ (Eo > 10) มันจะเสียรูปมากและเริ่มบิดเบี้ยว (Wobbly) ซึ่งเปลี่ยนรูปแบบการไหลรอบๆ ฟอง ทำให้ทิศทางของแรงยกกลับด้าน (Reverse Direction) แทนที่จะถูกผลักไปหาผนังเหมือนฟองเล็ก มันจะถูกผลักเข้าหากึ่งกลางท่อแทน ปรากฏการณ์นี้เรียกว่า "Wall Peeling" หรือ "Core Peaking"
    </details>

2.  **แรงยก Saffman (Saffman Lift) ขึ้นอยู่กับ Gradient ของอะไรเป็นหลัก?**
    <details>
    <summary>เฉลย</summary>
    ขึ้นอยู่กับ **Shear Rate** หรือ Gradient ของความเร็วเฟสต่อเนื่อง ($\partial u_c / \partial y$) ยิ่งมี Shear มาก (เช่น ใกล้ผนังท่อ) แรงยกยิ่งมีผลมาก
    </details>

3.  **ในท่อแนวตั้งที่มีฟองอากาศขนาดเล็ก (1 mm, Spherical) ฟองพวกนี้มีแนวโน้มจะไปรวมตัวกันที่ไหน?**
    <details>
    <summary>เฉลย</summary>
    ฟองกลมขนาดเล็กมักจะมี $C_L$ เป็นบวก (Positive Lift Coefficient) ใน Upward flow ซึ่งตามทิศทางของ Shear stress ในท่อ แรงยกจะผลักฟองเหล่านี้ **เข้าหาผนังท่อ (Near-wall accumulation)**
    </details>