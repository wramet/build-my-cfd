...
> [!TIP] **Physical Analogy: The Doctor's Diagnosis (การวินิจฉัยโรคของหมอ)**
>
> การเลือกโมเดลก็เหมือนหมอวินิจฉัยโรคและจ่ายยา:
>
> 1.  **Symptoms (อาการ):** ดูลักษณะการไหล (Flow Pattern) เห็นเป็นฟองเล็กๆ (Dispersed) หรือแยกชั้นน้ำมันกับน้ำชัดเจน (Separated)?
> 2.  **Diagnosis (วินิจฉัย):** ระบุโรค (Flow Regime) เช่น "โรคฟองกระจาย" (Dispersed Bubble Flow) หรือ "โรคท่อตัน" (Slug Flow)
> 3.  **Prescription (ใบสั่งยา):** เลือกโมเดล (Models)
>     -   *ยาพื้นฐาน:* แรง Drag (ต้องกินทุกคน)
>     -   *ยาเฉพาะทาง:* แรง Lift (ถ้ามี Shear flow), แรง Virtual Mass (ถ้าฟองเบามาก)
>     -   *ยาแรง:* KTGF (ถ้าอนุภาคหนาแน่นมากจนชนกันเอง)
>
> **กฏเหล็ก:** อย่าจ่ายยาเกินความจำเป็น! (Don't over-model) ถ้าเป็นแค่หวัด (Dilute flow) อย่าจ่ายยาเคมีบำบัด (Full KTGF with 4-way coupling) เพราะคนไข้ (Solver) จะน็อค (Unstable/Slow)
...
1.  **ถ้าเราเห็น "ฟองอากาศขนาดใหญ่คับท่อ" (Slug Flow) เราควรเลือกวิธี VOF หรือ Eulerian-Eulerian?**
    <details>
    <summary>เฉลย</summary>
    นี่เป็นกรณี **กึ่งกลาง (Gray Area)** แต่โดยทั่วไป:
    - ถ้าสนใจ **รูปร่างของฟองอากาศ** อย่างละเอียด -> ใช้ **VOF (`interFoam`)**
    - ถ้าสนใจ **ค่าเฉลี่ย** การไหลในท่อยาวๆ -> ใช้ **Eulerian (`multiphaseEulerFoam`)** พร้อมกับโมเดล Drag/Lift ที่รองรับ Slug flow
    </details>

2.  **ตัวเลข Eötvös Number ($Eo$) บอกอะไรเราในการเลือกโมเดล?**
    <details>
    <summary>เฉลย</summary>
    บอกถึง **"การเปลี่ยนรูปของฟอง"** (Deformation):
    - **$Eo < 1$:** ฟองแข็งเกร็ง (Spherical) -> ใช้ Schiller-Naumann
    - **$Eo > 1$:** ฟองเริ่มบิดเบี้ยว (Wobbly/Ellipsoidal) -> ต้องเปลี่ยนไปใช้ **Ishii-Zuber** หรือ **Tomiyama** ที่คำนึงถึงรูปทรง
    </details>

3.  **กลยุทธ์ "Start Simple" หมายความว่าอย่างไรในการปฏิบัติจริง?**
    <details>
    <summary>เฉลย</summary>
    หมายถึง **อย่าเปิดทุกโมเดลพร้อมกันตั้งแต่วินาทีแรก!**
    ให้เริ่มจำลองด้วย **Drag Force** เพียงอย่างเดียวก่อน เมื่อรันผ่านและผลดูสมเหตุสมผล แล้วค่อยๆ เพิ่ม Lift, Virtual Mass, และ Turbulent Dispersion ทีละตัว วิธีนี้จะช่วยให้เรารู้ว่า "ตัวไหนทำให้อาการแย่ลง" (Identify instability source)
    </details>